    ...
    <!-- END / HEADER -->
	 ...
	 <section id="login-content" class="login-content">
        ...
        <div class="container">
            <div class="row">
                <!-- FORM -->
				  <span id="errorMessage" style="color:#51f9cc;font-weight: bold;font-size: 20px;"><img src="${pageContext.request.contextPath}/images/homeslider/warning.png" style="height:80px;"/>This page is under the construction!!!!!!!!!!!!.</span>	
               	  <hr/>
                ...
                <div class="image">
                    <img src="${pageContext.request.contextPath}/images/homeslider/logged-in.png" alt="">
                </div>
