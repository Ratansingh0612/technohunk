                ...
                <div class="row">
                    <div class="feature-slider">
                        <div class="mc-item mc-item-1">
                            ...
                            <a href="${companyStudyMat}/core-java-quetions">Core Java</a>
                            </div>
                        ...
                        <div class="mc-item mc-item-1">
                            ...
                            <div class="meta-categories">
                             <img src="${pageContext.request.contextPath}/images/icon/edit.png" style="height: 30px;"/>
                            <a href="${companyStudyMat}/webservice-interview-questions">Web Services</a></div>
                            <div class="content-item">
                                <div class="image-author">
                                    <img src="images/avatar-1.png" alt="">
                                </div>
        ...
        <div class="container">
        	<div class="row category">
            	<div class="col-sm-4">
                    ...
                    <h2>IT Training <img src="${pageContext.request.contextPath}/images/icon/edit.png" style="height: 30px;"/>
                            	</h2>
    ...
    <div class="modal-content" style="background-image: url('${pageContext.request.contextPath}/images/bg/backgrounds.jpg');">
      ...
      <div class="form-group">
       ...
       Icon   :   <span style="font-weight: bold;color:red;">*</span>
        <input type="file" class="form-control" id="mobile" name="mobile"/>
        </div>
