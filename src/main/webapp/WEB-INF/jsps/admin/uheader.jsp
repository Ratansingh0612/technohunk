 <header id="header" class="header">
        <div class="container">
            ...
            <!-- LOGO -->
            <div class="logo"><a href="index-2.html"><img src="${pageContext.request.contextPath}/images/logo.png" alt=""></a></div>
            <!-- END / LOGO -->
                ...
                <ul class="menu">
                    ...
                    <li class="menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="${pageContext.request.contextPath}/action/assign-test-to-user">Assign Test</a></li>
                            <li><a href="${pageContext.request.contextPath}/action/consultant-test-status">Test History</a></li>
                            <li><a href="${pageContext.request.contextPath}/action/consultant-test-reset">Reset Test</a></li>
                        	<li> <a href="${pageContext.request.contextPath}/action/send-exam-link">Send Link</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="list-item account">
                        ...
                        <div class="toggle-account toggle-list">
                            <ul class="list-account">
                                ...
                                <li><a href="${pageContext.request.contextPath}/action/oauth"><i class="icon md-arrow-right"></i>Sign Out</a></li>
