...
<div id="page-wrap">
    ...
    <!-- HOME SLIDER -->
    <section class="slide" style="margin-bottom: 10px;margin-top: -28px;">
        <div class="container">
            ...
            <div class="after-slider-content tb">
                    <h4 style="font-family:'Neuton',serif; font-weight:200;font-size:18px; color:#000; letter-spacing:2px; text-transform:uppercase;">Test Result !</h4>
                     <%-- <form method="POST" action="${pageContext.request.contextPath}/action/guest-tech-test-history">
                      --%><form method="POST" action="${pageContext.request.contextPath}/action/guest-all-tech-test-history">
                    ...
                    <div class="feature-slider">
                      <c:forEach var="item" items="${popularJavaInterviewVOs}">
                        <div class="mc-item mc-item-1">
                            ...
                            <a href="${pageContext.request.contextPath}/${item.url}${item.techid}">${item.technology}</a>
                            </div>
                            ...
                            <div class="content-item">
                                ...
                                <div class="name-author">
                                    By <a href="${pageContext.request.contextPath}/${item.url}${item.techid}">${item.author}</a>
                                </div>
                            </div>
                             <div class="ft-item">
                                <div class="rating">
                            ...
                            <a href="${pageContext.request.contextPath}/action/soap-web-service-notes">Soap Web Service Notes</a>
                            </div>
                            ...
                            <div class="content-item">
                                ...
                                <h4><a href="course-intro.html">${item.text}</a></h4>
                                <div class="name-author">
                                    By <a href="${pageContext.request.contextPath}/action/soap-web-service-notes">${item.author}</a>
                                </div>
                            </div>
                             <div class="ft-item">
                                <div class="rating">
