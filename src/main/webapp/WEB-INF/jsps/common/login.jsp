        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-lg-4 pull-right">
                    <div class="form-login">
                        <form id="loginFormId" method="post" action="${pageContext.request.contextPath}/action/validateUser">
                            ...
                            <div class="link">
                                <a href="${pageContext.request.contextPath}/consultant/registration">
                ...
                <div class="image">
                        ...
                        <img src="${pageContext.request.contextPath}/action/dimage?imagePath=${loginContentVO.sliderImage}" alt=""> 
                </div>
