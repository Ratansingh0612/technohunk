   ...
   <!-- END / CONTENT BAR -->
	 ...
	 <section id="login-content" class="login-content">
        ...
        <div class="container">
            <div class="row">
                <!-- FORM -->
				  <span id="errorMessage" style="color:#000000;font-weight: bold;font-size: 20px;margin-left: 400px;"><img src="${pageContext.request.contextPath}/images/climbing.png" style="height:80px;"/>Your session has been timeout , please login once again!</span>	
               	  <hr/>
