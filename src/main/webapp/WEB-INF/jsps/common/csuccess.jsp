        ...
        <div class="container">
            <div class="info-author">
                ...
                <div class="name-author">
                    <h2 class="big" style="color:#E91E63;font-size: 24px;">${sessionScope.user_session_data.name}</h2>
                </div>     
            ...
            <div class="row" style="margin-top: 30px;">
                <!-- FORM -->
				  <span id="errorMessage" style="color:rgb(23, 86, 144);font-weight: bold;font-size: 17px;margin-left: 10px;">
				   <img src="${pageContext.request.contextPath}/images/mobile_confirm-256.png" style="height: 100px;"/>
				   ${ApplicationMessage}
				   </span>	
               	<!--   <hr/> -->
               	<br/>
