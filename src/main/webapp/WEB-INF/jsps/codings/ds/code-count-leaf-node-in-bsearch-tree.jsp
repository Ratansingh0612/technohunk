                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          ...
                          <img src="${pageContext.request.contextPath}/images/ds/binary-tree.gif"/>
                          <br/><br/> 
                          
                         <b> A node is a leaf node if both left and right child nodes of it are NULL.</b>
                           <span style="float: right;">
                           (${applicationScope.companyName})
                           </span>
                         </p>
                        
                   <p  class="probscrollcoll"> Write code to get the leaf node count in given binary search tree!.</p>
                    </div>
                </div>
                <!-- END / BLOG LIST -->
