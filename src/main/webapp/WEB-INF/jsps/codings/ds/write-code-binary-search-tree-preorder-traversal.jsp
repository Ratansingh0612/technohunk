...
<head>
    ...
    <title>${companyName} -Write your code to implement ArrayList</title>
    <!--[if lt IE 9]>
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          ...
                          <img src="${pageContext.request.contextPath}/images/ds/binary-tree-representation.jpg">
                          <img src="${pageContext.request.contextPath}/images/ds/binary-tree-representation.svg" style="height:100px;"/>
                          A Binary Search Tree (BST) is a tree in which all the nodes follow the below-mentioned properties - The <b>left</b> sub-tree of a node has a key less than or equal to its parent node's key. The <b>right</b> sub-tree of a node has a key greater than to its parent node's key.
                           <span style="float: right;">
                           (${applicationScope.companyName})
                           </span>
                         </p>
                        
                   <p  class="probscrollcoll"> Write code to implement the binary search  tree preorder traversal.</p>
                    </div>
                </div>
                <!-- END / BLOG LIST -->
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/custom-arraylist-code.jsp" %>
