...
<head>
    ...
    <title>${companyName} -Implement Own Comparator Coding Problem</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/employee.png">
                          ...
                          Comparable and Comparator in Java are very useful for sorting collection of objects. Java provides some inbuilt methods to sort primitive types array or Wrapper classes array or list.
                          <br/> 
                          <img src="${pageContext.request.contextPath}/images/codings/comprator-image.png"> 
                           <span style="float: right;">
                           (${applicationScope.companyName})
                           </span>
                         </p>
                        
                   <p  class="probscrollcoll"> As per above given description , please write your own code.</p>
