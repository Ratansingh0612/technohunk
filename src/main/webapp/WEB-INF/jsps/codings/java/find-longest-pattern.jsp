            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/find-longest-pattern.png">
                          <br/>
                           In above table letters are mapped. We have to find consecutive longest pattern.
                   ...
                   <p  class="probscrollcoll"> Possible letters patterns are T1 -> T2 -> T3  , T4 -> T5  and T7 -> T8 ->T9 ->T10.</p>
                   
                   <p  class="subscrollcoll"> So longest letters pattern will be T7 -> T8 ->T9 ->T10</p>
