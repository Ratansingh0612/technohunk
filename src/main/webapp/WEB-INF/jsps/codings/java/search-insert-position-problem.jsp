...
<head>
    ...
    <title>${companyName} -Search Insert Position Problem</title>
    <!--[if lt IE 9]>
    ...
    <section class="blog">
        <div class="container" style="background-color: white;">
            ...
            <div class="row">
				...
				<br/>
				<b>You may assume no duplicates in the array.</b>
                   ...
                   <p  class="probscrollcoll"> Sample Input :
                         ...
                         <p  class="subscrollcoll"> Sample Output :  2</p>
                   		     ...
                   		     <p  class="probscrollcoll"> Sample Input :
                   		<br/>  
                   		7   &nbsp;1   &nbsp; 3   &nbsp;5  &nbsp; 6                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -> input int arrays
                   		</p>
                   		
                         <p  class="subscrollcoll"> Sample Output :  4</p>
                             <p  class="probscrollcoll"> Sample Input :
                   		<br/>  
                   		0   &nbsp;1   &nbsp; 3   &nbsp;5  &nbsp; 6                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -> input int arrays
                   		</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/search-insert-position-problem-code.jsp" %>
