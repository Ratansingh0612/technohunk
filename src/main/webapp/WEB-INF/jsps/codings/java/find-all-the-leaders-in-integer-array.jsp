...
<head>
    ...
    <title>${companyName} -Find all the leaders in an integer array</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                        An element is said to be a leader if all the elements on it's right side are smaller than it. Rightmost element is always a leader. For example, if {14, 9, 11, 7, 8, 5, 3} is the given array then {14, 11, 8, 5, 3} are the leaders in this array.</p>
                   <p  class="probscrollcoll"> For a given integer array , print leaders in the array shown as below.</p>
                   
                   <p  class="subscrollcoll"> Sample Input : 14 &nbsp;&nbsp; 9&nbsp;&nbsp; 11&nbsp;&nbsp; 7&nbsp;&nbsp; 8&nbsp;&nbsp; 5&nbsp;&nbsp; 3<span style="margin-left:100px;">(array of integers space separated)</span></p>
                         <p  class="subscrollcoll"> Sample Output :  14&nbsp;&nbsp; 11&nbsp;&nbsp; 8&nbsp;&nbsp; 5&nbsp;&nbsp; 3</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/find-all-leaders-code.jsp" %>
