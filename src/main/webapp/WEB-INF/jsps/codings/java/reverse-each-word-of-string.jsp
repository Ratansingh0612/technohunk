...
<head>
    ...
    <title>${companyName} -Reverse Each word of a String</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/reverse-individual-words.png">
                         </p>
                   <p  class="probscrollcoll">Given a string , we need to print reverse of individual words as shown in above picture..</p>
                   
                   <p  class="subscrollcoll"> Sample Input :  Java is really not easy</p>
                         <p  class="subscrollcoll"> Sample Output :  avaJ si yllaer ton ysae</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/reverse-each-word-code.jsp" %>
