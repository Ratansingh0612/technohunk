...
<head>
    ...
    <title>${companyName} -Find politeness of a number</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/politeness-of-a-number.png">
                         .(Wikipedia)</p>
                   <p  class="probscrollcoll"> Given a number , find total politeness of it & print it and if number has no sum of consecutive numbers then print impolite.</p>
                   
                   <p  class="subscrollcoll"> Sample Input :  <b>15</b> , Sample Output :  <b>3</b></p>
                        <p  class="probscrollcoll"> Sample Input :  <b>9</b>  , Sample Output :  <b>2</b> </p>
                        
                          <p  class="subscrollcoll"> Sample Input :  <b>16</b> , Sample Output :  <b>impolite</b></p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/find-politeness-code.jsp" %>
