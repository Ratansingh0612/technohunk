...
<head>
    ...
    <title>${companyName} -Longest Valid Parentheses (Java)</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                         	 <img src="${pageContext.request.contextPath}/images/codings/paremthesis2.jpg">
                         	 <br/>
							Given a string containing just the characters '(' and ')', find the longest valid (well-formed) parentheses substring.		  
                         </p>
                          <p  class="scrollcoll">
                         For "(()", the longest valid parentheses substring is "()", which has length = 2.
Another example is ")()())", where the longest valid parentheses substring is "()()", which has length = 4.
                     </p>
                   <p  class="probscrollcoll"> Sample Input :  (()</p>
                         <p  class="subscrollcoll"> Sample Output :  ()</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/longest-parentheisis-code.jsp" %>
