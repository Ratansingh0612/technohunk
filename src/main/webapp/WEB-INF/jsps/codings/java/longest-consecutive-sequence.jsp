...
<head>
    ...
    <title>${companyName} -Longest Consecutive Sequence</title>
    <!--[if lt IE 9]>
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                                                   ...
                                                   <img src="${pageContext.request.contextPath}/images/codings/longest-consecutive-sequence.png"/>
						 ...
						 <br/> <br/>
                          ...
                          <p  class="scrollcoll">
For example, given [49, 1,3, 200, 2, 4, 70,5], the longest consecutive elements sequence should be [1, 2, 3, 4,5]. Its length is 5.
                     </p>
                     
                      <p  class="probscrollcoll">
                    Sample Input :  49 &nbsp;&nbsp; 1 &nbsp;&nbsp; 3 &nbsp;&nbsp; 200 &nbsp;&nbsp; 2 &nbsp;&nbsp; 4&nbsp;&nbsp;  70 &nbsp;&nbsp;  5
                    
                     <span style="margin-left:100px;">= > Integers array separated by space</span>
                   </p>
                   
                     <p  class="subscrollcoll">
 Sample Output : 5  &nbsp;&nbsp;&nbsp; , which is length  and final array is 1&nbsp;&nbsp; 2&nbsp;&nbsp; 3&nbsp;&nbsp; 4&nbsp;&nbsp;5
                     </p>
                    </div>
                </div>
                <!-- END / BLOG LIST -->
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/longest-consecutive-code.jsp" %>
