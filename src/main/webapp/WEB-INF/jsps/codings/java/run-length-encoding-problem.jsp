...
<head>
    ...
    <title>${companyName} -Run Length Encoding Problem!</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                        Write a method that accepts a string and performs a run length encoding on the string. Run length encoding works by looking for long runs of a character in the string and replacing the run with a pair consisting of the number of occurrences in the run, followed by the character itself.
                         </p>
                   <p  class="probscrollcoll"> Sample Input :  AAABBAAAAABBBCCCCCCCCCAAAAA</p>
                         <p  class="subscrollcoll"> Sample Output :  3A2B5A3B9C5A</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/run-length-encoding-code.jsp" %>
