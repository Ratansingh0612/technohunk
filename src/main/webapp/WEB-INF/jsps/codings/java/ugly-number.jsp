            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                         <img src="${pageContext.request.contextPath}/images/codings/number-icons.png">
                         <br/>
                      Write a program to find the n-th ugly number.
 <br/> <br/>
Ugly numbers are positive numbers whose prime factors only include <b>2, 3, 5.</b> 
                         </p>
  ...
  <p  class="probscrollcoll"><b>Output Format</b> :  	<br/>
 	print the integer value
              ...
              <b>Note:</b>  
<br/>
<b>1.</b> 1 is typically treated as an ugly number.<br/>
<b>2.</b> n does not exceed 1690.
                   	</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/ugly-number-code.jsp" %>
