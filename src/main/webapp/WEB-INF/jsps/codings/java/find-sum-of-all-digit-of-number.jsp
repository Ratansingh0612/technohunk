...
<head>
    ...
    <title>${companyName} -Find sum of all digits of a number!</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/calculate-sum-of-digit.png">
                        </p>
                   <p  class="probscrollcoll"> Given a number , print sum of all it's digit.</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/print-sum-all-digits.jsp" %>
