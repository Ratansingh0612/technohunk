...
<head>
    ...
    <title>${companyName} -Alphabet Soup Problem</title>
    <!--[if lt IE 9]>
        ...
        <div class="container" style="background-color: white;">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                   ...
                   <p  class="subscrollcoll"> Sample Input :  coderbyte , Sample Output :  bcdeeorty</p>
                         <p  class="subscrollcoll"> Sample Input :  hooplah ,Sample Output :  ahhloop</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/alphabet-soup-code.jsp" %>
