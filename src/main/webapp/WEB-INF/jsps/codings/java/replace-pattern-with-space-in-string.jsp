...
<head>
    ...
    <title>${companyName} -Replace all $#$ in string by space</title>
    <!--[if lt IE 9]>
        ...
        <div class="container" style="background-color: white;">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                   ...
                   <p  class="probscrollcoll"> Given an input array of int 1,2,3,4,6,7,8,9,10 (1-10) ===>  print missing number which is 5 .</p>
                   <p  class="probscrollcoll"> Given an input array of int 1,2,3,4,6,7,8,9,10,12,13,14,15 (1-15) ===>  print missing number which is 11</p>
                    </div>
                </div>
                <!-- END / BLOG LIST -->
