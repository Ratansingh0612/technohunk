...
<head>
    ...
    <title>${companyName} -First repeated non repeated character in string</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          Given a string, your code must find out the first repeated as well as non-repeated character in that string. For example, if "WeLoveJavaProgramming" is the given string, then 'W' is a first non-repeated character and '2' is a first repeated character.  Have a look at the below image.
                          <br/>	
                           For given string we have to find first repeated and non repeated character.
                           <br/> <br/>
                           <img src="${pageContext.request.contextPath}/images/codings/first-repeated-non.png"> 
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/first-repeated-non-repeated-character-in-string-code.js" %>
