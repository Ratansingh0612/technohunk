...
<head>
    ...
    <title>${companyName} -Tally Program Problem</title>
    <!--[if lt IE 9]>
                ...
                <div class="col-md-8">
                   ...
                   <p  class="probscrollcoll"> Sample Input : 
                       ...
                       abcde
                         ...
                         <p  class="subscrollcoll"> Sample Output :  a:1,b:1,c:1,d:1,e:1</p>
                         
                          <p  class="probscrollcoll"> Sample Input :   <br/>
                       dbbaCEDbdAacCEAadcB</p>
                         <p  class="subscrollcoll"> Sample Output :  b:2,d:2,a:1,c:0,e:-2</p>
                    </div>
                </div>
                <!-- END / BLOG LIST -->
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/tally-code.jsp" %>
