...
<head>
    ...
    <title>${companyName} -Find number is power of two or not!!!!!!!!!</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/power-of-two.png">
                           <span style="float: right;">
                           (${applicationScope.companyName})
                           </span>
                         </p>
                        
                   <p  class="probscrollcoll"> Given an input number , you have to print yes if number is power of 2 else no.</p>
                   
                   <p  class="subscrollcoll"> Sample Input :  128 ,Sample Output :  yes</p>
                         <p  class="subscrollcoll"> Sample Input :  453 , Sample Output :  no</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/power-of-two-code.jsp" %>
