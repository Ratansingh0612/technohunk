...
<head>
    ...
    <title>${companyName} -GCD of two numbers</title>
    <!--[if lt IE 9]>
...
GCD (Greatest Common Divisor) or HCF (Highest Common Factor) of two numbers is the largest number that divides both of them.
                         ...
                         For example- GCD of  48,18=6, GCD of 6 ,18 = 6
...
Print the GCD of the two given  numbers.
                   ...
                   <p  class="probscrollcoll"> Sample Input :  <br/>98 <br/>56</p>
                   
                    <p  class="subscrollcoll"> Sample Output :  14</p>
                         
                                  <p  class="probscrollcoll"> Sample Input :  <br/>48 <br/>18 </p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/gcd-of-two-numbers-code.jsp" %>
