...
<head>
    ...
    <title>${companyName} -String Index Problem</title>
    <!--[if lt IE 9]>
        ...
        <div class="container" style="background-color: white;">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                   ...
                   <p  class="subscrollcoll"> Sample Input :  kittens  , Sample Output :  kien</p>
                         <p  class="subscrollcoll"> Sample Input :  chocolate  , Sample Output :  chole</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/string-index-code.jsp" %>
