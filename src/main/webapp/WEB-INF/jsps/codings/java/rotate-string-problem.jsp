...
<head>
    ...
    <title>${companyName} -Rotate String Problem</title>
    <!--[if lt IE 9]>
...
<div id="page-wrap">
  ...
  <br/> <br/>
A shift on A consists of taking string A and moving the leftmost character to the rightmost position. For example, if A = <b>'abcde'</b>, then it will be <b>'bcdea'</b> after one shift on A. Return True if and only if A can become B after some number of shifts on A.
                         </p>
  ...
  <p  class="probscrollcoll"><b>Output Format</b> :  	<br/>
 	print the boolean value <b>true</b> if condition is matched otherwise print value <b>false</b>
                  	                   	</p>
                   	                   	
                   
               <p  class="probscrollcoll"> Sample Input :  
                   	<br/><b>abcde</b><br/> <b>cdeab</b></p>
                         <p  class="subscrollcoll"> Sample Output :  true</p>
                         
                         
                               <p  class="probscrollcoll"> Sample Input :  
                   	<br/><b>abcde</b><br/> <b>abced</b></p>
                         <p  class="subscrollcoll"> Sample Output :  false</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/rotate-string-code.jsp" %>
