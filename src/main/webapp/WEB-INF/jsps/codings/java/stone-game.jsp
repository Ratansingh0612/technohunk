...
<head>
    ...
    <title>${companyName} -Stone Game</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                         <img src="${pageContext.request.contextPath}/images/codings/piles-stone.jpg">
                         <br/>
...
Assuming Alex and Lee play optimally, return True if and only if Alex wins the game.
                   	...
                   	<br/>
                   		A single line which contains piles of stone with positive integer number of stones piles[i]. 
						</p>
  <p  class="probscrollcoll"><b>Output Format</b> :  	<br/>
 Assuming Alex and Lee play optimally, return <b>true</b> if and only if Alex wins the game otherwise return <b>false</b>
...
If Lee takes the last 5, then the board is [3, 4], and Alex takes 4 to win with 9 points.<br/><br/>
