...
<head>
    ...
    <title>${companyName} -Find Longest Increasing Subsequence </title>
    <!--[if lt IE 9]>
                ...
                <div class="col-md-8">
                   ...
                   Given an array of numbers, find the length of the longest increasing subsequence in the array. The subsequence does not necessarily have to be contiguous.
                    ...
                    <p  class="probscrollcoll"> <b>Input Format </b>  <br/>  
                      Enter array of number in one line separated by space.
                   	 </p>
                   
                   	
                   	 <p  class="probscrollcoll"> <b>Output Format </b>  <br/>  
                   	 For each test case, print the longest increasing subsequence.
                   	 </p>
                   ...
                   <p  class="probscrollcoll"> Sample Input :
                         ...
                         <p  class="subscrollcoll"> Sample Output :  0 2 6 9 11 15</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/find-longest-increasing-code.jsp" %>
