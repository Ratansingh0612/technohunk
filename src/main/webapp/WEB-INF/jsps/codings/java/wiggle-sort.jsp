            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <br/> <br/>
                     Given an unsorted array nums, reorder it such that <b>nums[0] < nums[1] > nums[2] < nums[3]....</b>
                                 </p>
  ...
  <p  class="probscrollcoll"><b>Output Format</b> :  	<br/>
 	 Return String with multiple values separated with space in single line
               ...
               <p  class="subscrollcoll"> Sample Input :  
                   	<br/><b>1&nbsp;&nbsp; 5&nbsp;&nbsp; 1&nbsp;&nbsp; 1&nbsp;&nbsp; 6&nbsp;&nbsp; 4</b>
                   	<br/><br/>
                   	Sample Output :  <b>1&nbsp;&nbsp;  4&nbsp;&nbsp;  1&nbsp;&nbsp;  5&nbsp;&nbsp;  1&nbsp;&nbsp;  6</b>
                   	</p>
                   	
                   	 <p  class="subscrollcoll"> Sample Input :  
                   	<br/><b>1&nbsp;&nbsp; 3&nbsp;&nbsp; 2&nbsp;&nbsp; 2&nbsp;&nbsp; 3&nbsp;&nbsp; 1</b>
                   	<br/><br/>
                   	Sample Output :  <b>2&nbsp;&nbsp; 3&nbsp;&nbsp; 1&nbsp;&nbsp; 3&nbsp;&nbsp; 1&nbsp;&nbsp; 2</b>
                   	</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/wiggle-sort-code.jsp" %>
