...
<div id="page-wrap">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <br/> <br/>
                    Given a positive <b>integer n</b>, break it into the sum of  <b>at least</b> two positive integers and maximize the product of those integers. Return the maximum product you can get.
                         </p>
  ...
  <p  class="probscrollcoll"><b>Output Format</b> :  	<br/>
 	print the integer value as per problem statement described above.
                  	                   	</p>
                   ...
                   <p  class="subscrollcoll">Sample Input :  
             		...
             		<b>Note:</b> You may assume that n is not less than 2 and not larger than 58.
                   	</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/integer-break-code.jsp" %>
