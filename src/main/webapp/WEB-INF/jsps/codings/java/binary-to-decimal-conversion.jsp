...
<head>
    ...
    <title>${companyName} -Binary to decimal  conversion!</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/binary-to-decimal.png"/>
                   ...
                   <p  class="probscrollcoll"> Given a binary number , print decimal representation of it.</p>
                    ...
                    Sample Input :  11011011
                     <span style="margin-left:100px;">= > Binary input</span>
                   </p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/binary-decimal-code.jsp" %>
