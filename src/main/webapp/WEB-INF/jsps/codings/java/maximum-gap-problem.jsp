...
<head>
    ...
    <title>${companyName} -Maximum gap problem</title>
    <!--[if lt IE 9]>
        ...
        <div class="container" style="background-color: white;">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                   ...
                   <p  class="scrollcoll">
                <img src="${pageContext.request.contextPath}/images/codings/gap.png">    
                <br/>
               Given an unsorted array, find the maximum difference between the successive elements in its sorted form.
				<br/><br/>
				<b>Note:</b> Return 0 if the array contains less than 2 elements.
                             </p>
...
Input: [3,6,9,1]<br/>
Output: 3<br/>
<b>Explanation:</b> The sorted form of the array is [1,3,6,9], either<br/>
             (3,6) or (6,9) has the maximum difference 3.<br/>
       </p>   
   <p  class="probscrollcoll">          
   <b>Example 2:</b><br/>
Input: [10]<br/>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/maximum-gap-problem-code.jsp" %>
