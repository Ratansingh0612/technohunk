...
<head>
    ...
    <title>${companyName} -Sort Array using quick sort algorithm</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/quick-sort-algorithm.png">
                           <span style="float: right;">
                           (${applicationScope.companyName})
                           </span>
                         </p>
                        
                   <p  class="probscrollcoll"> Given an input , you have to sort array element in ascending order.</p>
                   
                   <p  class="subscrollcoll"> Sample Input :  12 &nbsp;  23&nbsp; 33&nbsp; 43&nbsp; 55&nbsp; 44&nbsp; 64&nbsp; 77&nbsp; 75</p>
                         <p  class="subscrollcoll"> Sample Output :  <span style="color:black;"> &nbsp;  23&nbsp; 33&nbsp; 43&nbsp;44&nbsp; 55&nbsp;  64&nbsp; 75&nbsp; 77</span></p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/special-pyramid-code.jsp" %>
