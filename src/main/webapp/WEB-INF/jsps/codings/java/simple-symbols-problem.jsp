...
<head>
    ...
    <title>${companyName} -Simple Symbols Problem!</title>
    <!--[if lt IE 9]>
        ...
        <div class="container" style="background-color: white;">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                   ...
                   <p  class="subscrollcoll"> Sample Input :  +d+=3=+s+</p>
                         <p  class="subscrollcoll"> Sample Output :  Yes</p>
                          <p  class="subscrollcoll"> Sample Input :  f++d+</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/simple-symbole-code.jsp" %>
