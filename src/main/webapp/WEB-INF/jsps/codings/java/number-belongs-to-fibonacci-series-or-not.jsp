...
<head>
    ...
    <title>${companyName} - Check number belongs to Fibonacci series or not</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/fibonacci-seria.png">
                         </p>
                   <p  class="probscrollcoll"> Fibonacci series is the series of numbers where each number is obtained by adding two previous numbers. The first two numbers in the Fibonacci series are either 1 and 1 or 0 and 1.</p>
                   
                   <p  class="subscrollcoll"> Sample Input :  5 , Sample Output :  Yes</p>
                         
                         <p  class="subscrollcoll"> Sample Input :  9 , Sample Output :  No</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/number-belongs-fibo.jsp" %>
