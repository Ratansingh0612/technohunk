...
<head>
    ...
    <title>${companyName} -Happy Number Problem</title>
    <!--[if lt IE 9]>
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <hr/>
                          ...
                          <img src="${pageContext.request.contextPath}/images/codings/happy-number.png">
                        </p>
                   <p  class="scrollcoll"> Given a number , print "yes" if number is happy else print "no".</p>
                     <p  class="probscrollcoll"> Sample Input : 23</p>
                     <p  class="subscrollcoll"> Sample Output : yes</p>
                      <p  class="probscrollcoll"> Sample Input : 9</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/happy-num-code.jsp" %>
