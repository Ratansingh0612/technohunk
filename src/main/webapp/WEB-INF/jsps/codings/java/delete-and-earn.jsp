            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <br/> <br/>
                        Given an array nums of integers, you can perform operations on the array.   <br/> <br/>
                          In each operation, you pick any <b>nums[i]</b> and delete it to earn  <b>nums[i]</b> points. After, you must delete every element equal to <b>nums[i] - 1</b> or <b>nums[i] + 1</b>.
                           <br/> <br/>
                           You start with 0 points. Return the maximum number of points you can earn by applying such operations.
                          </p>  
                  <p  class="probscrollcoll"><b>Input Format</b> :  	<br/>
The first line contains n space-separated integers, where each ar[i] describes integer value.
                  	                   	</p>
...
Return the maximum number of points you can earn
               ...
               <p  class="subscrollcoll"> Sample Input1 :  
                   	<br/><b>3 &nbsp;&nbsp;4 &nbsp;&nbsp;2</b>
                   	<br/><br/>
                   	Sample Output1 :  <b> 6</b><br/><br/>
                   	<b>Explanation</b> <br/>
                   	Delete 4 to earn 4 points, consequently 3 is also deleted.<br/>
Then, delete 2 to earn 2 points. 6 total points are earned.
                     ...
                     <p  class="subscrollcoll"> Sample Input2 :  
                   	...
                   	<b>2&nbsp;&nbsp; 2&nbsp;&nbsp; 3&nbsp;&nbsp; 3&nbsp;&nbsp; 3&nbsp;&nbsp; 4</b>
                   	<br/><br/>
                   	Sample Output2 :  <b> 9</b><br/><br/>
                   	<b>Explanation</b> <br/>
                   Delete 3 to earn 3 points, deleting both 2's and the 4.<br/>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/delete-and-earn-code.jsp" %>
