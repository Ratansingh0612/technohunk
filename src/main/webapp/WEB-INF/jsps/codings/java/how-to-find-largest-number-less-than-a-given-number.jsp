...
<head>
    ...
    <title>${companyName} -How to find largest number less than a given number!</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                   ...
                   <p  class="probscrollcoll"> Sample Input :  <br/>
                   		145   <span style="margin-left:100px;">(Given number)</span>
                   		
                   		 <br/>4<span style="margin-left:140px;">(Given Digit)</span></p>  
                         <p  class="subscrollcoll"> Sample Output :  139</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/find-largest-number-less-code.jsp" %>
