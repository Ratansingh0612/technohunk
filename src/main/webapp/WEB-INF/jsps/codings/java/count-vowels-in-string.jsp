...
<head>
    ...
    <title>${companyName} -Count Vowels in String!!</title>
    <!--[if lt IE 9]>
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          ...
                          <img src="${pageContext.request.contextPath}/images/codings/java-method-image-exercise-4.png">
                          <br/><br/>
                          <br/>Write a Java method to count all vowels in a string.
                         </p>
                   <p  class="probscrollcoll"> Given a string , count all vowels and print it.</p>
                   
                   <p  class="subscrollcoll"> Sample Input :  This website is aw3som3 , Sample Output :  7</p>
                         <p  class="subscrollcoll"> Sample Input :  welcome in coding exercise , Sample Output :  10</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/count-vowels-code.jsp" %>
