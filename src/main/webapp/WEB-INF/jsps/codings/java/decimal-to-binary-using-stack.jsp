...
<head>
    ...
    <title>${companyName} -Decimal to Binary using Stack</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/decimal-to-binary.jpg">
                         ...
                         .(Wikipedia)</p>
                   <p  class="probscrollcoll"> Given a number , print binary representation of number if it is a valid result, print No otherwise.</p>
                   
                   <p  class="subscrollcoll"> Sample Input :  6 , Sample Output :  110 , Sample Input :  7 , Sample Output :  111</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/decimal-to-binary.jsp" %>
