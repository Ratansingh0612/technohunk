...
<head>
    ...
    <title>${companyName} -Divisors Problem</title>
    <!--[if lt IE 9]>
...
Example- when N=6  then only 4 have 3 divisors(1,2 and 4).If N=10 then only 4 and 9 have 3 divisors ,so answer should be 2 . 
...
Output format:
the answer of each test case .
</p>
                   
                   <p  class="subscrollcoll"> Sample Input :  6 , Sample Output :  1</p>
                         
                                  <p  class="subscrollcoll"> Sample Input :  10 , Sample Output :  2</p>
                         
                              <p  class="subscrollcoll"> Sample Input :  30 , Sample Output :  3</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/divisors-code.jsp" %>
