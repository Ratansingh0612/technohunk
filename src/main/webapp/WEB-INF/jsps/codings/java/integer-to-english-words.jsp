...
<head>
    ...
    <title>${companyName} - Integer to English Words</title>
    <!--[if lt IE 9]>
...
<div id="page-wrap">
  ...
  <p  class="probscrollcoll"><b>Output Format</b> :  	<br/>
 	Print the english words representation.
                  	                   	</p>
               ...
               <p  class="subscrollcoll"> Sample Input :  
                   	<br/><b>123</b>
                   	<br/><br/>
                   	Sample Output :  <b>"One Hundred Twenty Three"</b>
                   	</p>
                   	...
                   	<br/><b>12345</b>
                   	 	<br/><br/>
                   	 	Sample Output :  <b>"Twelve Thousand Three Hundred Forty Five"</b>
                   	 	
                   	</p>
                          <p  class="subscrollcoll"> Sample Input :  
                   	<br/><b>1234567</b>
                   	<br/><br/>
                   	Sample Output :  <b>"One Million Two Hundred Thirty Four Thousand Five Hundred Sixty Seven"</b>
                   	</p>
                       
                   	 <p  class="probscrollcoll"> Sample Input :  
                   	<br/><b>1234567891</b>	<br/><br/>
                   	Sample Output :  <b>"One Billion Two Hundred Thirty Four Million Five Hundred Sixty Seven Thousand Eight Hundred Ninety One"</b>
                   	</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/integer-to-english-word-code.jsp" %>
