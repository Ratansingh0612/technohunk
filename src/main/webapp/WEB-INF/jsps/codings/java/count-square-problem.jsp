...
<head>
    ...
    <title>${companyName} -Count Square Problem</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                     ...
                     Given a sample space S consisting of all perfect squares starting from 1, 4, 9 and so on. You are given a number N, you have to print the number of integers less than N in the sample space S (ie- you have to print no of perfect squares < N ).
For example-if given no is 9 then number of perfect squares less than 9 are 2(ie 1 and 4).


                          
                         </p>
                   <p  class="probscrollcoll">Input format:
contains an integer N, denoting the number.
</p>
 <p  class="probscrollcoll">
Output format:
print no of perfect squares < N
</p>
                   
                   <p  class="subscrollcoll"> Sample Input :  9 , Sample Output :  2</p>
                       
                         
                                  <p  class="subscrollcoll"> Sample Input :  3 , Sample Output :  1</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/count-square-code.jsp" %>
