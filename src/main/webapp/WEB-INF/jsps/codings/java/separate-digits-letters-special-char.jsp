...
<head>
    ...
    <title>${companyName} -Separate Digits Letters Special Chars Problems</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                        	This is normal string problem where user has to take string "898dhjdfhds9764^&%hdhed7436464hb374744nbfd848484AAOUEU834&&^$^$^" which includes
                        	digits, chars and special characters and user has to write code to separate digits , chars and special chars together 
                   ...
                   <p  class="subscrollcoll"> Sample Input :  $$833328ba2ab&^12&@#op</p>
                         <p  class="subscrollcoll"> Sample Output :  833328212baabop$$^&@#</p>
                   <p  class="subscrollcoll"> Sample Input :  a918f$g%#@#h12#</p>
                         <p  class="subscrollcoll"> Sample Output : 91812afgh%#@##</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/separate-digits-letters-special-char-code.jsp" %>
