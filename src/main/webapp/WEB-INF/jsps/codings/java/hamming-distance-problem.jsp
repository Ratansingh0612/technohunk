...
<head>
    ...
    <title>${companyName} -Hamming Distance Problem.</title>
    <!--[if lt IE 9]>
...
Given two integers x and y, calculate the Hamming distance.
                        ...
                        <p  class="subscrollcoll">   Example1:
                        <br/>
Input: x = 1, y = 4 <br/>
Output: 2<br/>
<b>
Explanation:
	...
	<img src="${pageContext.request.contextPath}/images/codings/hamming-1.png"/>
                         
                         </p>
                         
                          <p  class="subscrollcoll">   Example2:
                        <br/>
Input: x = 4, y =9  <br/>
Output: 3<br/>
<b>
Explanation:
	...
	<img src="${pageContext.request.contextPath}/images/codings/hamming-2.png"/>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/hamming-distance-problem-code.jsp" %>
