...
<head>
    ...
    <title>${companyName} -Letter Capitalize Problem</title>
    <!--[if lt IE 9]>
        ...
        <div class="container" style="background-color: white;">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                   ...
                   <p  class="subscrollcoll"> Sample Input :  hello energy</p>
                         <p  class="subscrollcoll"> Sample Output :  Hello Energy</p>
                          <p  class="subscrollcoll"> Sample Input :  i love java programming</p>
                         <p  class="subscrollcoll"> Sample Output :  I Love Java Programming</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/letter-capitalize-code.jsp" %>
