            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                         <img src="${pageContext.request.contextPath}/images/codings/rabbit.png">
                         <br/> <br/>
...
The first line describes arr as n space-separated integers representing the answers arr[i] given by rabbit.
                  	                   	</p>
...
Return the integer value
               ...
               <p  class="subscrollcoll"> Sample Input1 :  
                   	<br/><b>1 &nbsp;&nbsp;1 &nbsp;&nbsp;2</b>
                   	<br/><br/>
                   	Sample Output1 : <br/> <b> 5</b><br/><br/>
                   	<b>Explanation</b> <br/>
                   The two rabbits that answered "1" could both be the same color, say red.<br/>
The rabbit than answered "2" can't be red or the answers would be inconsistent.<br/>
...
The smallest possible number of rabbits in the forest is therefore 5: 3 that answered plus 2 that didn't.
                      ...
                      <p  class="subscrollcoll"> Sample Input2 :  
                   	<br/><b>10 &nbsp;&nbsp;10&nbsp;&nbsp;10</b>
                   	<br/><br/>
                   	Sample Output2 : <br/> <b> 12</b><br/><br/>
                   	</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/rabbits-in-forest-code.jsp" %>
