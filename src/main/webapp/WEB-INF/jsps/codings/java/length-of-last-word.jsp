...
<head>
    ...
    <title>${companyName} -Length of last word!</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/algorithms.png">
                          <br/>
...
<b>Note:</b> A word is defined as a character sequence consists of non-space characters only.
                   ...
                   <p  class="subscrollcoll"> Sample Input :  <b>"Hello World"</b> , Sample Output :  <b>5</b></p>
                        <p  class="probscrollcoll"> Sample Input :  <b>"Hello Mr. How are you"</b>  , Sample Output :  <b>3</b> </p>
                         <p  class="probscrollcoll"> Sample Input :  <b>"Cool"</b>  , Sample Output :  <b>0</b> </p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/length-of-last-word-code.jsp" %>
