...
<head>
    ...
    <title>${companyName} -Painter Partition Problem</title>
    <!--[if lt IE 9]>
...
this job done under the constraints that any painter will only paint continuous sections of boards, say board {2, 3, 4} or only board {1} or nothing but not board {2, 4, 5}.
                   ...
                   <p  class="probscrollcoll"> Sample Input :
                   		<br/>  
                   		10 10 10 10                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -> input int arrays
                   		<br/>2</p>
                         <p  class="subscrollcoll"> Sample Output :  20 </p>
                         
                          <p  class="probscrollcoll"> Sample Input :  <br/>  
                   		10 20  30  40                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -> input int arrays
                   		<br/>2</p>
                         <p  class="subscrollcoll"> Sample Output :  60</p>
                         
                          <p  class="probscrollcoll"> <b>Explanation :</b>
                   		<br/>  
                   		Test case1: 
                   		Input : k = <b>2</b>, A = <b>{10, 10, 10, 10} </b>
Output : <b>20.</b>
Here we can divide the boards into <b>2</b>
equal sized partitions, so each painter 
gets <b>20</b> units of board and the total
time taken is <b>20.</b> 

<br/><br/>
Input : k = <b>2</b>, A = <b>{10, 20, 30, 40}</b> 
Output : <b>60.</b>
Here we can divide first <b>3</b> boards for
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/painter-partition-problem-code.jsp" %>
