...
<head>
    ...
    <title>${companyName} -Perfect Square Problem</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/perfect-square-num.png">
                         </p>
                   <p  class="probscrollcoll"> Sample Input :  7</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/perfect-square-code.jsp" %>
