...
<head>
    ...
    <title>${companyName} -Menu Choice Pattern</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/menu-choice-pattern.png">
                           In above problem two inputs are given, where first input represents food & associated country
                           and second input represents "person name" and their "country". for example "Nagen" likes 
                           "italian" , "Tonmoy" likes "Chinese" and "Alex" likes "*" means all kind of foods.
                           So with the help of both inputs table , you have to print third table where 
                           you have to show, who likes which foods as shown in third table.
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/menu-pattern-code.jsp" %>
