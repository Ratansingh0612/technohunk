...
<head>
    ...
    <title>${companyName} -Print Maximum Sum Subarray!</title>
    <!--[if lt IE 9]>
        ...
        <div class="container" style="background-color: white;">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                   ...
                   <p  class="scrollcoll"> 
                 You are given an array of integers (all positive/all negative/combination of both). Find the
contiguous sequence with the largest sum. Return the  contiguous  subarray.
                   ...
                   <p  class="probscrollcoll"> Sample Input :
                   		<br/>  
                   		2 &nbsp;  -8&nbsp;   3&nbsp;   -2&nbsp;   4 &nbsp;  -10                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -> input int arrays
                   		</p>
                         <p  class="subscrollcoll">Sample Output :  3	&nbsp;  -2 	&nbsp; 4</p>
                         
                         <br/>  
                         <p  class="probscrollcoll"> Sample Input :
                   		-3 &nbsp;  -2&nbsp;   -1                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -> input int arrays
                   		</p>
                         <p  class="subscrollcoll">Sample Output :  -1</p>
                         
                          <br/>  
                          <p  class="probscrollcoll"> Sample Input :
                   		1 &nbsp;  2&nbsp;   3                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -> input int arrays
                   		</p>
                         <p  class="subscrollcoll">Sample Output :  1 &nbsp;  2&nbsp;   3   </p>
                         
                         
                          <p  class="probscrollcoll"> <b>Explanation :</b>
                   		<br/>  
                   		Test case1: 
                   	For Input array : 2, -8, 3, -2, 4, -10
Output will be : [3, -2, 4]  as max sum is 5 corresponding to subarray  { 3, -2, 4} .
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/print-maximum-sum-subarray-code.jsp" %>
