            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                         <img src="${pageContext.request.contextPath}/images/codings/winner.png">
                         <br/> <br/>
  ...
  <p  class="probscrollcoll"><b>Output Format</b> :  	<br/>
 	 Return boolean value true or false
               ...
               <p  class="subscrollcoll"> Sample Input :  
                   	...
                   	<b>Explanation:</b> <br/>
Initially, player 1 can choose between 1 and 2. <br/>
...
Hence, player 1 will never be the winner and you need to return False.
                   	...
                   	<b>Explanation:</b> <br/>
Player 1 first chooses 1. Then player 2 have to choose between 5 and 7. No matter which number player 2 choose, player 1 can choose 233. <br/>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/predict-the-winner-code.jsp" %>
