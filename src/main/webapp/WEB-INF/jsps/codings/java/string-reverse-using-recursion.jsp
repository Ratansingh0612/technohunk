...
<head>
    ...
    <title>${companyName} -String Reverse Using Java</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                        	Here we have to write code to reverse a String using recursive function.
                         </p>
                   <p  class="probscrollcoll"> Sample Input :  Google</p>
                         <p  class="subscrollcoll"> Sample Output :  elgooG</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/string-reverse-using-recursion-code.jsp" %>
