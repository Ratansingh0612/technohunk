...
<head>
    ...
    <title>${companyName} -Sum of two integers</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <img src="${pageContext.request.contextPath}/images/codings/sum-of-two-nums.jpg">
                         <br/>
                   ...
                   <p  class="subscrollcoll"> Sample Input :  
                   	<br/><b>10</b><br/> <b>50</b></p>
                         <p  class="probscrollcoll"> Sample Output :  60</p>
                         
                         <p  class="subscrollcoll"> Sample Input :  
                   	<br/><b>99</b><br/> <b>101</b></p>
                         <p  class="probscrollcoll"> Sample Output :  200</p>
                    </div>
                </div>
                <!-- END / BLOG LIST -->
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/sum-of-two-integers-code.jsp" %>
