...
<head>
    ...
    <title>${companyName} -Print All Permutation Of String</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/string-permutation.png">
                           <span style="float: right;">
                           (${applicationScope.companyName})
                           </span>
                         </p>
                        
                   <p  class="probscrollcoll"> Given an input , you have to print the all string permutation.</p>
                   
                   <p  class="subscrollcoll"> Sample Input :  abc</p>
                         <p  class="subscrollcoll"> Sample Output :  ["abc", "bac", "bca","acb" ,"cab", "cba"]</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/print-all-permutation-of-string-code.jsp" %>
