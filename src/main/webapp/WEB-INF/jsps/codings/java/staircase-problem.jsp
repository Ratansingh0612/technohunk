...
<head>
    ...
    <title>${companyName} -Staircase Problem </title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                   ...
                   <p  class="probscrollcoll">
                        <img src="${pageContext.request.contextPath}/images/codings/staircase-problem.png">
                    There's a staircase with N steps, and you can climb 1 or 2 steps at a time. Given N, write a function that returns the number of unique ways you can climb the staircase. The order of the steps matters.
<br/><br/>
<b>For example, if N is 4, then there are 5 unique ways:</b>
<br/>
a)&nbsp;&nbsp;&nbsp; 1, 1, 1, 1<br/>
b)&nbsp;&nbsp;&nbsp; 2, 1, 1<br/>
c)&nbsp;&nbsp;&nbsp; 1, 2, 1<br/>
...
What if, instead of being able to climb 1 or 2 steps at a time, you could climb any number from a set of positive integers X? For example, if X = <b>{1, 3, 5}</b>, you could climb 1, 3, or 5 steps at a time. Generalize your function to take in X.

                   
                   </p>
                   
                    <p  class="probscrollcoll"> <b>Input/Output Format :</b>  <br/>  
                   		First Line contains number of stairs
                   		<br/>	
                   		Second line contains integers array that denotes the no of steps at a time.
                   ...
                   <p  class="probscrollcoll"> Sample Input :
                         ...
                         <p  class="subscrollcoll"> Sample Output :  5</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/staircase-code.jsp" %>
