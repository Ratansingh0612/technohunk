...
<head>
    ...
    <title>${companyName} -Multiply String</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                        ...
                        <br/>
                         <img src="${pageContext.request.contextPath}/images/codings/string-multiply.png">  
                         </p>
                   ...
                   <p  class="probscrollcoll"> Sample Input : 
                       ...
                       123<br/>456</p>
                         <p  class="subscrollcoll"> Sample Output :  56088</p>
                    </div>
                </div>
                <!-- END / BLOG LIST -->
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/multiply-strings-code.jsp" %>
