...
<head>
    ...
    <title>${companyName} -Program to Concatenate two Strings Lexically</title>
    <!--[if lt IE 9]>
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          ...
                          <img src="${pageContext.request.contextPath}/images/codings/lexicographical-con.png">
                   ...
                   <p  class="subscrollcoll"> Sample Input :  
                   	<br/><b>hello this</b><br/> <b>is programmer from google</b></p>
                         <p  class="subscrollcoll"> Sample Output :  from google hello is programmer this</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/concatenate-two-strings-code.jsp" %>
