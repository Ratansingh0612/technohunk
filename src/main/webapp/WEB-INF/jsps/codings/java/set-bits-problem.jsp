...
<head>
    ...
    <title>${companyName} -Set Bits Problem!</title>
    <!--[if lt IE 9]>
                    ...
                    <div class="blog-list-content">
                   	  <!-- POST -->
                          ...
                          <span style="margin-left: 20px;font-size: 18px;color:#61b91a;width:400px;font-weight: bold;">	
                            ...
                            <p  class="probscrollcoll"> Given a positive integer N, print count of set bits in it. For example, if the given number is 6 (binary: 110), output should be 2 as there are two set bits in it.</p>
                  
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/set-bits.png" class="img-thumbnail">
                         </p>
                  
                   <p  class="subscrollcoll"> Sample Input :  <b>6</b> , Sample Output :  <b>2</b></p>
                        <p  class="probscrollcoll"> Sample Input :  <b>11</b>  , Sample Output :  <b>3</b> </p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/set-bits-code.jsp" %>
