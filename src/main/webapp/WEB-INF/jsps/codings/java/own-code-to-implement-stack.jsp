...
<head>
    ...
    <title>${companyName} -Write your own code to implement stack!</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/stack-implementation.png">
                           <span style="float: right;">
                           (${applicationScope.companyName})
                           </span>
                         </p>
                        
                   <p  class="probscrollcoll"> Write your own code to implement Stack <b>Data Structure</b>.</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/stack-code.jsp"%>
