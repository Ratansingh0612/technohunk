...
<head>
    ...
    <title>${companyName} -Voting System App</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/voting-system-app.png">
                          in above diagram string is representing votes of different party separated by space.
                          Where "CPP" , "PP" , "DP" , "BJP" , "PO" etc. are different party names and 
                          represents a  vote inside given string for particular party. You have write a code
                          to find the party names who has highest and second highest votes in above given string.  
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/voting-system-code.jsp" %>
