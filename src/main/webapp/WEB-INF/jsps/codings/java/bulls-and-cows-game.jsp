...
<head>
    ...
    <title>${companyName} -Bulls & Cows Game</title>
    <!--[if lt IE 9]>
        ...
        <div class="container" style="background-color: white;">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                   ...
                   <br/>  
                   1807  <span style="margin-left: 150px">(secret)</span>
                   <br/> 
                   7810  <span style="margin-left: 150px">(guess)</span>
                   </p>
                            <p  class="subscrollcoll"> Sample Output  :  1A3B</p>
                         
                          <p  class="subscrollcoll"> Hint: 1 bull and 3 cows. (The bull is 8, the cows are 0, 1 and 7.)
Write a function to return a hint according to the secret number and friend's guess, use A to indicate the bulls and B to indicate the cows. In the above example, your function should return "1A3B".</p>
                    </div>
                </div>
                <!-- END / BLOG LIST -->
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/bulls-cows-code.jsp" %>
