            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <br/>
                      Given a string S of '(' and ')' parentheses, we add the minimum number of parentheses ( '(' or ')', and in any positions ) so that the resulting parentheses string is valid.<br/>  <br/>
                        
                      Formally, a parentheses string is valid if and only if:
<br/>  <br/>
<b>1)</b> It is the empty string, or<br/>
<b>2)</b> It can be written as AB (A concatenated with B), where A and B are valid strings, or<br/>
<b>3) </b>It can be written as (A), where A is a valid string.
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/minimum-add-to-make-parentheses-valid-code.jsp" %>
