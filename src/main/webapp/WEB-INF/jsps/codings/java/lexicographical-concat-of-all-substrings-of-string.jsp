                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          ...
                          <img src="${pageContext.request.contextPath}/images/codings/lexicographical-substring.png">
                   ...
                   <p  class="subscrollcoll"> Sample Input :  
                   	<b>abc</b></p>
                         <p  class="subscrollcoll"> Sample Output :  aababcbbcc</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/lexicographical-of-substring.jsp" %>
