...
You may assume the dictionary does not contain duplicate words.
                    ...
                    <p  class="probscrollcoll"><b>Input Format</b> :  
                   	<br/>
					First line represents the String  and second line represents array of string comma separated
					dictionary wordDict   
			</p>
  <p  class="probscrollcoll"><b>Output Format</b> :  	<br/>
 	 Return true if it matches the condition describes in problem statement else return false
                  ...
                  <b> Synergistic&nbsp;&nbsp; IT</b>
                   ...
                   <b>Explanation:</b> Return true because "JavaHunk" can be segmented as "Synergistic IT".
</p> 
...
<p  class="subscrollcoll">
                   Sample Input : <br/>
					<b>catsandog</b>
				   <br/>   
                  <b> cats&nbsp;&nbsp; dog&nbsp;&nbsp; sand&nbsp;&nbsp; and&nbsp;&nbsp; cat</b>
                   <br/><br/>
                   Sample Output : false<br/>
</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/word-break-problem-code.jsp" %>
