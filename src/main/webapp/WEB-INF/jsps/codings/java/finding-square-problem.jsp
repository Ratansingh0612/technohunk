...
<head>
    ...
    <title>${companyName} -Find Square problem</title>
    <!--[if lt IE 9]>
...
Print "Yes" (without quotes) if it is square else "No".
                   ...
                   <p  class="subscrollcoll"> Sample Input :  20 10 10 20 20 20 10 10   <span style="margin-left:100px;">(array of integers space separated)</span></p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/finding-square-code.jsp" %>
