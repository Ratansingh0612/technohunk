...
<head>
    ...
    <title>${companyName} -Count the number of unival subtrees in a binary tree</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <img src="${pageContext.request.contextPath}/images/codings/unival-1.png">
                          <img src="${pageContext.request.contextPath}/images/codings/unival-2.png">
                          <img src="${pageContext.request.contextPath}/images/codings/unival-3.png">
                          <img src="${pageContext.request.contextPath}/images/codings/unival-4.png">
                        
                   <p  class="probscrollcoll"> Write your own code to count the number of unival subtrees in a binary tree.</p>
