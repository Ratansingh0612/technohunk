            ...
            <div class="row">
              ...
              Given two strings A and B of lowercase letters, return true if and only if we can swap two letters in A so that the result equals B.
                   ...
                   <p  class="subscrollcoll">Ex-1 Sample Input :  
                   	<br/><b>ab</b><br/> <b>ba</b><br/><br/>
                   	Sample Output :  true
                   	</p>
                         
                         
                          <p  class="subscrollcoll">Ex-2 Sample Input :  
                   	<br/><b>ab</b><br/> <b>ab</b><br/><br/>
                   	Sample Output :  false
                   	
                   	</p>
                         
                                    <p  class="subscrollcoll">Ex-3 Sample Input :  
                   	<br/><b>aa</b><br/> <b>aa</b>
                   	<br/><br/> Sample Output :  true
                   	</p>
                         
                              <p  class="subscrollcoll">Ex-4 Sample Input :  
                   	<br/><b>aaaaaaabc</b><br/> <b>aaaaaaacb</b>
                   	<br/><br/>
                   	Sample Output :  true
                   	</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/buddy-strings-code.jsp" %>
