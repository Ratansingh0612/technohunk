...
<head>
    ...
    <title>${companyName} -Find interleavings of two strings</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         C string is said to be interleaving A and B, if it contains all characters of A and B and order of all characters in individual strings is preserved.
                         <br/><br/>
                   ...
                   <p  class="subscrollcoll"> Sample Input :  
                   	<br/><b>AB</b><br/> <b>CD</b></p>
                         <p  class="subscrollcoll"> 
                         Sample Output : ABCD ACBD ACDB CABD CADB CDAB</p>
                         
                         
                             <p  class="subscrollcoll"> Sample Input :  
                   	<br/><b>AB</b><br/> <b>C</b></p>
                         <p  class="subscrollcoll"> 
                         Sample Output :  ABC ACB CAB</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/find-interleaving-strings-code.jsp" %>
