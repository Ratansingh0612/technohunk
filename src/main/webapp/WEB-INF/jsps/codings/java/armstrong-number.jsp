...
<head>
    ...
    <title>${companyName} -Armstrong  Number</title>
    <!--[if lt IE 9]>
        ...
        <div class="container" style="background-color: white;">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                   ...
                   <p  class="probscrollcoll"> Given a number , print "Yes"  if number is a armstrong, print "No" otherwise.</p>
                   
                   <p  class="subscrollcoll"> Sample Input :  153  , Sample Output :  Yes</p>
                   <p  class="probscrollcoll"> Sample Input :  122  , Sample Output :  No</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/armstrong-num-code.jsp" %>
