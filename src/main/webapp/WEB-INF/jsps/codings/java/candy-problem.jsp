...
<head>
    ...
    <title>${companyName} -Candy Problem!</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                         <img src="${pageContext.request.contextPath}/images/codings/candy-problem.png">
                         <br/>
...
What is the minimum candies you must give?
                   	...
                   	<br/>
                   		A single line, given a array of non-negative representing <b>N</b> children standing in a line  
                   		and each child is  assigned a rating value.
						</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/candy-problem-code.jsp" %>
