...
<head>
    ...
    <title>${companyName} -Program to find occurrence of String</title>
    <!--[if lt IE 9]>
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          ...
                          <img src="${pageContext.request.contextPath}/images/codings/occurence-of-substring.png">
                          <br/>You are given a string and a word your task is that count the number of the occurrence of the given word in the string and print the number of occurrence of the word..
                         </p>
                   <p  class="probscrollcoll"> For given a string and a word , count all occurrence of word in given string.</p>
                   
                   <p  class="subscrollcoll">
                   Input : <br/><br/>
                   JavaHunk is a consulting services and Training Organization and deals with Training
                   <br/>
Training
<br/>
</p>
...
2
                         ...
                         <p  class="subscrollcoll">
                   Input : <br/><br/>
                   JavaHunk is a consulting services and Training Organization
                   <br/>
			java
</p>
  <p  class="subscrollcoll">
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/count-substring-code.jsp" %>
