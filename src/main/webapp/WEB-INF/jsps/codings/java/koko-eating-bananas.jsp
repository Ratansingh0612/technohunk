            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                         <img src="${pageContext.request.contextPath}/images/codings/koko-banana.png">
                         <br/>
             Koko loves to eat bananas.  There are N piles of bananas, the i-th pile has piles[i] bananas.  The guards have gone and will come back in H hours.
                <br/>   <br/>
                         ...
                         Return the minimum integer K such that she can eat all the bananas within H hours.
                             ...
                             <p  class="subscrollcoll"><b>Input Format</b> :  
                   	<br/>
                   		First line represents the piles and second line represents H hours.
                   	                   	</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/koko-eating-banana-code.jsp" %>
