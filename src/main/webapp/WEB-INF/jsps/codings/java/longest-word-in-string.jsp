...
<head>
    ...
    <title>${companyName} -Longest word in String</title>
    <!--[if lt IE 9]>
        ...
        <div class="container" style="background-color: white;">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                   ...
                   <p  class="subscrollcoll"> Sample Input :  "fun&!! time"</p>
                         <p  class="subscrollcoll"> Sample Output :  "time"</p>
                         
                          <p  class="subscrollcoll"> Sample Input :  "I love dogs"</p>
                         <p  class="subscrollcoll"> Sample Output :  "love"</p>
                    </div>
                </div>
                <!-- END / BLOG LIST -->
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/longest-word-instring-code.jsp" %>
