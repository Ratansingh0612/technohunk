...
<head>
    ...
    <title>${companyName} -Check String 7 Digit Number</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                         In this coding exercise you can use regular expression to check if String contains only digits i.e. 0 to 9 and length should be 7. If String only contains digit then its number otherwise its not a numeric String
                         </p>
                         
                     <p  class="probscrollcoll"> Given a string , print Yes if it contains only digits and its length is seven, print No otherwise.</p>     
                   <p  class="subscrollcoll"> Sample Input :  9182827 , Sample Output :  Yes</p>
                         
                   <p  class="subscrollcoll"> Sample Input :  81711 , Sample Output :  No</p>
                         
                         <p  class="subscrollcoll"> Sample Input :  we81711 , Sample Output :  No</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/check-string-seven-digit-number-code.jsp" %>
