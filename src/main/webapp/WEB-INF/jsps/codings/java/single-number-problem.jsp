...
<head>
    ...
    <title>${companyName} -Single Number Problem</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
				...
				Your algorithm should have a linear runtime complexity. 
                   ...
                   <p  class="probscrollcoll"> Sample Input :
                   		<br/>  
                   		2&nbsp; 2&nbsp; 1             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -> input int arrays
                   		</p>
                         <p  class="subscrollcoll"> Sample Output :  2</p>
                         
                            <p  class="probscrollcoll"> Sample Input :
                   		<br/>  
                   		4&nbsp; 1&nbsp; 2 &nbsp;1&nbsp; 2             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -> input int arrays
                   		</p>
                         <p  class="subscrollcoll"> Sample Output :  4</p>
                          ...
                          <p  class="probscrollcoll"> <b>Explanation :</b>
                   		<br/>  
                   		Test case2: 
                   		For Input array : 4&nbsp; 1&nbsp; 2 &nbsp;1&nbsp; 2    
						Output will be : <b>4</b> because only 4 does not appears twice while other digits appear twice.
                   		</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/single-number-problem-code.jsp" %>
