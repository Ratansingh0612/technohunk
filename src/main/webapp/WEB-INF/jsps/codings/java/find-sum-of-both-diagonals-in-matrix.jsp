...
<head>
    ...
    <title>${companyName} -Find sum of both diagonals in matrix</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/sum-of-both-diagonals-in-matrix.png">
