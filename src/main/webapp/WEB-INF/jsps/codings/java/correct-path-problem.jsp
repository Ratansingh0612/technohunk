...
<head>
    ...
    <title>${companyName} -Correct Path Problem</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <%-- <img src="${pageContext.request.contextPath}/images/codings/all-unique-chars.png"> --%>
                   ...
                   <p  class="probscrollcoll"> For example: if str is "r?d?drdd" then your program should output the final correct string that will allow a path to be formed from the top left of a 5x5 grid to the bottom right. For this input, your program should therefore return the string rrdrdrdd. There will only ever be one correct path and there will always be at least one question mark within the input string..</p>
                   <p  class="subscrollcoll"> Sample Input :  ???rrurdr? ,Sample Output : dddrrurdrd</p>
                   <p  class="subscrollcoll"> Sample Input :  drdr??rrddd? ,Sample Output : drdruurrdddd </p>
                    </div>
                </div>
                <!-- END / BLOG LIST -->
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/correct-path-code.jsp" %>
