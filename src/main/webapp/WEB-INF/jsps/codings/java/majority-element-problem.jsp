...
<head>
    ...
    <title>${companyName} -Majority element problem</title>
    <!--[if lt IE 9]>
        ...
        <div class="container" style="background-color: white;">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                   ...
                   <p  class="scrollcoll"> 
          Given an array of size n, find the majority element. The majority element is the element that appears more than <b>[n/2]</b> times.
You may assume that the array is non-empty and the majority element always exist in the array.
                   ...
                   <p  class="probscrollcoll"> Sample Input :
                   		<br/>  
                   		3 &nbsp;  2   &nbsp;  3                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -> input int arrays
                   		</p>
                         <p  class="subscrollcoll">Sample Output :  3</p>
                         
                         <br/>  
                         <p  class="probscrollcoll"> Sample Input :
                   		2&nbsp;  2&nbsp;   1&nbsp;1&nbsp;1 2&nbsp;  2                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -> input int arrays
                   		</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/majority-element-problem-code.jsp" %>
