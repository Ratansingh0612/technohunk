...
<head>
    ...
    <title>${companyName} -Pairs Array Whose Sum is equal to given number</title>
    <!--[if lt IE 9]>
        ...
        <div class="container" style="background-color: white;">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                   ...
                   <p  class="scrollcoll"> For example, if {4, 5, 7, 11, 9, 13, 8, 12} is an array and 20 is the given number, then you have to find all pairs of elements in this array whose sum must be 20.</p>
                   
                   <p  class="probscrollcoll"> Sample Input :
                   		<br/>  
                   		4 5 7 11 9 13 8 12	
                   		<br/>20</p>
                         <p  class="subscrollcoll"> Sample Output :  (9, 11),(7, 13),(8, 12) </p>
                         
                          <p  class="probscrollcoll"> Sample Input :  <br/>  
                   		4 5 7 11 9 13 8 12	
                   		<br/>26</p>
                         <p  class="subscrollcoll"> Sample Output :  () , when pair does not exist!</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/pairs-array-whose-sum.jsp" %>
