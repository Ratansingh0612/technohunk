...
<head>
    ...
    <title>${companyName} -Swap two strings without using third variable</title>
    <!--[if lt IE 9]>
...
You have to take two strings s1 and s2 , after swapping contents should be interchanged.
                   ...
                   <p  class="subscrollcoll"> Sample Input :  
                   	<br/><b>Ahmed</b><br/> <b>Saleh</b></p>
                         <p  class="subscrollcoll"> Sample Output :  Saleh Ahmed</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/swap-two-strings-code.jsp" %>
