...
<head>
    ...
    <title>${companyName} -Sort string using selection sort</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/selection-sort.jpg">
                           <span style="float: right;">
                           (${applicationScope.companyName})
                           </span>
                         </p>
                        
                   <p  class="probscrollcoll"> Given a input , you have to sort string using selection sort.</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/program-sort-selection-sort-code.jsp" %>
