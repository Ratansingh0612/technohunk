...
<head>
    ...
    <title>${companyName} -String Rotation Problem</title>
    <!--[if lt IE 9]>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/string-rotation-code.jsp" %>
