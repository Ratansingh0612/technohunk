                ...
                <div class="col-md-8">
                  ...
                  <b>Note:</b> You are not suppose to use the library's sort function for this problem.
                   ...
                   <p  class="probscrollcoll"> Sample Input :
                         ...
                         <p  class="subscrollcoll"> Sample Output :  0&nbsp;&nbsp;0&nbsp;&nbsp;1&nbsp;&nbsp;1&nbsp;&nbsp;2&nbsp;&nbsp;2</p>
                         
                         
                           <p  class="probscrollcoll"> Sample Input :1&nbsp;&nbsp;1&nbsp;&nbsp;0&nbsp;&nbsp;&nbsp;1&nbsp;&nbsp;1&nbsp;&nbsp;0&nbsp;&nbsp;2
                   		<br/>  
                   		
                   		
                   		</p>
                         <p  class="subscrollcoll"> Sample Output :  0&nbsp;&nbsp;0&nbsp;&nbsp;1&nbsp;&nbsp;1&nbsp;&nbsp;1&nbsp;&nbsp;1&nbsp;&nbsp;2</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/sort-color-code.jsp" %>
