                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                       ...
                       Given two strings of letters, determine whether the second can be made from the first by removing one letter. The remaining letters must stay in the same order.
                          ...
                          <p  class="probscrollcoll"> <b>Examples :</b> 
                           <br/>
								funnel("leave", "eave") => true <br/>
								funnel("reset", "rest") => true <br/>
								funnel("dragoon", "dragon") => true <br/>
                       </p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/funnel-code.jsp" %>
