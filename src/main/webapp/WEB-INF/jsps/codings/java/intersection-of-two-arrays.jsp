...
<br/>
<b>Note:</b><br/>
Each element in the result must be unique and in sorted order.

                              		
                              </p>
                             
                   
                  		 <p  class="probscrollcoll"> Sample Input1 :
                   		<br/>  
                   		1&nbsp; 2 &nbsp;2&nbsp; 1      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -> input int arrays
                   		<br/>2&nbsp; 2  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -> input int arrays</p>
                         <p  class="subscrollcoll"> Sample Output1 :  2</p>
                         
                         
                         		 <p  class="probscrollcoll"> Sample Input2 :
                   		<br/>  
                   		4&nbsp; 9 &nbsp;5&nbsp; 1      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -> input int arrays
                   		<br/>9&nbsp; 4&nbsp; 9 &nbsp; 8&nbsp; 4&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -> input int arrays</p>
                         <p  class="subscrollcoll"> Sample Output2 :  2 9 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -> only one space between both the numbers</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/intersection-of-two-arrays-code.jsp" %>
