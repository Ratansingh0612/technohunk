...
<div id="page-wrap">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                         <img src="${pageContext.request.contextPath}/images/codings/binary-num.png">
                         <br/><br/>
                    Given a non negative integer number num. For every numbers i in the range 
                    <b style="background-color: #c1e0f9;">0 <= i <= num</b> calculate the number of <b>1'</b> in their binary representation and return them as a String separated by comma.
                         </p>
  ...
  <p  class="probscrollcoll"><b>Output Format</b> :  	<br/>
 	print the String value as per the problem statement describes above 
                  	                   	</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/counting-binary-code.jsp" %>
