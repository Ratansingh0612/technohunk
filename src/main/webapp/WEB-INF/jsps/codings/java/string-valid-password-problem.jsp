...
<head>
    ...
    <title>${companyName} -Check string is valid password</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/string-password.png">
                         </p>
...
<li>A password must contain at least two digits.</li>
                    ...
                    <span style="font-size: 19px;color: black;">if password is correct as per above rules then print "valid" else print "invalid".</span>
                   <p  class="subscrollcoll"> Sample Input :  abcd1ww234 , Sample Output :  valid</p>
                     <p  class="subscrollcoll"> Sample Input :  abcd$@#1234 , Sample Output :  invalid</p>
                    </div>
                </div>
                <!-- END / BLOG LIST -->
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/string-password-code.jsp" %>
