...
<head>
    ...
    <title>${companyName} -Special U Pattern</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/special-u-pattern-problem.png">
                           <span style="float: right;">
                           (${applicationScope.companyName})
                           </span>
                         </p>
                        
                   <p  class="probscrollcoll"> Given an input , you have to print the pattern for input n as shown above.</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/special-upattern-code.jsp" %>
