...
<head>
    ...
    <title>${companyName} -Factorial of a Number!</title>
    <!--[if lt IE 9]>
...
Given n and k, return the kth permutation sequence.<br/>  <br/>

<b>Note:</b>
<br/>
Given n will be between 1 and 9 inclusive.
Given k will be between 1 and n! inclusive.<br/>
First line in input represent n and second line k
                   </p>
                   
                   		<p  class="subscrollcoll"> Sample Input1 :  <br/>
		                   <b>5</b><br/>
    		               <b>3</b> 
            		    </p>
                        <p  class="probscrollcoll"> Sample Output1 :  <b>"213"</b> </p>
                        
                        
                        <p  class="subscrollcoll"> Sample Input2 :  <br/>
		                   <b>4</b><br/>
    		               <b>9</b> 
            		    </p>
                        <p  class="probscrollcoll"> Sample Output2 :  <b>"2314"</b> </p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/kth-permutation-sequence-code.jsp" %>
