...
<head>
    ...
    <title>${companyName} -Word Multiple Problem</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/word-count.png">  
                          <br/>
                        Given an array of strings, return a Map<String, Boolean> where each different string is a key and its value is true if that string appears 2 or more times in the array.
                          </p>
                   <p  class="scrollcoll"> Given an input array of String "a", "b", "a", "c", "b" ===>  print {a=true, b=true, c=false}.</p>
                   
                   <p  class="probscrollcoll"> Sample Input :  a  b  a  c  b    <span style="margin-left: 150px;">(multiple string space separated)</span> </p>
                         <p  class="subscrollcoll"> Sample Output :  {a=true, b=true, c=false}</p>
                         
                          <p  class="probscrollcoll"> Sample Input :  AT PT GT OP GT AT OP    <span style="margin-left: 150px;">(multiple string space separated)</span> </p>
                         <p  class="subscrollcoll"> Sample Output :  {AT=true, PT=false, GT=true, OP=true}</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/word-multiple-code.jsp" %>
