...
<head>
    ...
    <title>${companyName} -Program to find the Hidden Number</title>
    <!--[if lt IE 9]>
...
Output: 2<br/>
<b>Explanation:</b> <br/>
Substracting all the elements of arrays from 2,<br/>
The sum of difference is:<br/>
1 + 0 + (-1) = 0.  <br/>
                             </p>
                   ...
                   <p  class="probscrollcoll"> Sample Input :
                   		<br/>  
                   		  ...
                   		  <b>1&nbsp; 2&nbsp; 3</b>   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -> input int arrays
                   		</p>
                         <p  class="subscrollcoll"> Sample Output : <b>2</b></p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/program-to-find-hidden-number-code.jsp" %>
