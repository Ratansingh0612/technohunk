...
<head>
    ...
    <title>${companyName} -Excel sheet column title problem</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/excel-sheet-ttile.png">
                         </p>
                   <p  class="probscrollcoll"> Given a positive integer, return its corresponding column title as appear in an Excel sheet.
                     <br/>
                     <img src="${pageContext.request.contextPath}/images/codings/execel-sheet-problem.png">
                   </p>
                   
                   <p  class="subscrollcoll"> Sample Input :  <b>1</b> , Sample Output :  <b>"A"</b></p>
                        <p  class="probscrollcoll"> Sample Input :  <b>28</b>  , Sample Output :  <b>"AB"</b> </p>
                          <p  class="probscrollcoll"> Sample Input :  <b>701</b>  , Sample Output :  <b>"ZY"</b> </p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/excel-sheet-column-title-problem-code.jsp" %>
