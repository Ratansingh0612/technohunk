...
<head>
    ...
    <title>${companyName} - Longest Common Prefix </title>
    <!--[if lt IE 9]>
...
If there is no common prefix, return an empty string "".  <br/>
  ...
  <p  class="probscrollcoll"><b>Output Format</b> :  	<br/>
 	 Return longest common prefix string if exists otherwise "" string with length 0.
              
                  	                   	</p>
                   	                   	
                   
               <p  class="subscrollcoll"> Sample Input :  
                   	<br/><b>"flower" &nbsp;&nbsp;"flow"&nbsp;&nbsp;"flight"</b>
                   	<br/><br/>
                   	Sample Output :  <b>"fl"</b>
                   	</p>
                         
                         
                               <p  class="probscrollcoll"> Sample Input :  
                   	<br/><b>"dog" &nbsp;&nbsp;"racecar" &nbsp;&nbsp;"car"</b>
                   	 	<br/><br/>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/longest-common-prefix-code.jsp" %>
