...
<head>
    ...
    <title>${companyName} -Find Longest Substring Without Repeated Chars</title>
    <!--[if lt IE 9]>
        ...
        <div class="container" style="background-color: white;">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                   ...
                   <p  class="subscrollcoll"> Sample Input :  abcabcbb , Sample Output :  abc</p>
                         <p  class="probscrollcoll"> Sample Input :  bbbbb ,  Sample Output :  b</p>
                         <p  class="subscrollcoll">Sample Input :  ABCDEFGA , Sample Output :  BCDEFGA </p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/find-longest-substring-without-repeated-chars-code.jsp" %>
