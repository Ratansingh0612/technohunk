...
<head>
    ...
    <title>${companyName} -Check number is prime or not!</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/prime-numbers.png">
                          <br/>
                   ...
                   <p  class="probscrollcoll"> Given a number , print "Yes"  if number is a prime, print "No" otherwise.</p>
                   
                   <p  class="subscrollcoll"> Sample Input :  79 , Sample Output :  Yes</p>
                   <p  class="subscrollcoll"> Sample Input :  122 , Sample Output :  No</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/prime-num-code.jsp" %>
