...
<head>
    ...
    <title>${companyName} -Find sum of upper triangle in matrix</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/sum-of-upper-tringle.png">
                           <span style="float: right;">
                           (${applicationScope.companyName})
                           </span>
                         </p>
                        
                     <p  class="probscrollcoll"> Write your own code to find sum of all elements upper triangle in matrix..</p>
