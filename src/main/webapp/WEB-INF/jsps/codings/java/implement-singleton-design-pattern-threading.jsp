...
<head>
    ...
    <title>${companyName} -Implementing singleton design pattern!</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/singleton-design-pattern.jpg">
                   ...
                   <p  class="probscrollcoll"> Implement lazy way instantiating of Singleton Design Pattern for Multi Threading Environment.</p>
                   
                   <p  class="subscrollcoll"> Sample Input :  NA</p>
                         <p  class="subscrollcoll"> Sample Output :  NA</p>
