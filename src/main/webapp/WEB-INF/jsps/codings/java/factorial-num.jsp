            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         .(Wikipedia)</p>
                   <p  class="probscrollcoll"> Given a number , print factorial number if it is a valid result, print No otherwise.</p>
                   
                   <p  class="subscrollcoll"> Sample Input :  <b>5</b> , Sample Output :  <b>120</b></p>
                        <p  class="probscrollcoll"> Sample Input :  <b>-2</b>  , Sample Output :  <b>No</b> </p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/factorial-num.jsp" %>
