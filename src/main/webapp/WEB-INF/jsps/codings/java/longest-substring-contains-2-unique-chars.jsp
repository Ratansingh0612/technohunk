...
<head>
    ...
    <title>${companyName} -Longest substring contains 2 unique chars</title>
    <!--[if lt IE 9]>
        ...
        <div class="container" style="background-color: white;">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                   ...
                   <p  class="probscrollcoll"> For example, given "abcbbbbcccbdddadacb", the longest substring that contains 2 unique character is "bcbbbbcccb".</p>
                   
                           <p  class="probscrollcoll">
                    Sample Input : abcbbbbcccbdddadacb
                   </p>
                   
                                     <p  class="subscrollcoll">
                                      Sample Output : bcbbbbcccb
                                     </p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/longest-substring-code.jsp" %>
