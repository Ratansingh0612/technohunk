...
<head>
    ...
    <title>${companyName} -Find Smallest and Largest Number from Array</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/smallest-largest-value-array.png">
                       </p>
                   <p  class="probscrollcoll"> 
Find Smallest & Largest Num from a given int array.</p>
                   
                   <p  class="subscrollcoll"> Sample Input :  10  92 23 43 90 12 34 45 87</p>
                   <p  class="subscrollcoll"> Sample Output : 10,92    <span style="margin-left:300px;">= > smallest, largest</span></p>
                    </div>
                </div>
                <!-- END / BLOG LIST -->
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/smallest-largest-code.jsp" %>
