...
<head>
    ...
    <title>${companyName} -Minimum Window Substring</title>
    <!--[if lt IE 9]>
                    ...
                    <div class="blog-list-content">
                       ...
                       Given a string S and a string T, find the minimum window in S which will contain all the characters in T in complexity O(n).
						For example, S = "ADOBECODEBANC", T = "ABC", Minimum window is "BANC".  
                           ...
                           <p  class="subscrollcoll"><b> Sample Input :</b> <br/>
                           this is a test string
                           <br/>
                            tist<span style="margin-left:300px;">(pattern)</span>
                          </p>
                             <p  class="probscrollcoll"> <b>Sample Output :</b>  Minimum window is "t stri" </p>
                           <p  class="subscrollcoll"> <b> Sample Input </b> :  <br/>geeksforgeeks<br/>ork
                           <span style="margin-left:300px;">(pattern)</span>
                            </p>
                           <p  class="probscrollcoll"> <b>Sample Output :</b>  Minimum window is "ksfor" </p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/minimum-window-code.jsp" %>
