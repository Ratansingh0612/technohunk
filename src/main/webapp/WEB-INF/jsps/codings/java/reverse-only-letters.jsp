...
<head>
    ...
    <title>${companyName} - Reverse Only Letters</title>
    <!--[if lt IE 9]>
...
<div id="page-wrap">
  ...
  <p  class="probscrollcoll"><b>Output Format</b> :  	<br/>
 	Print the reverse string as per problem statement.
                  	                   	</p>
               ...
               <p  class="subscrollcoll"> Sample Input :  
                   	<br/><b>"ab-cd"</b>
                   	<br/><br/>
                   	Sample Output :  <b>"dc-ba"</b>
                   	</p>
                         
                         
                               <p  class="probscrollcoll"> Sample Input :  
                   	<br/><b>"a-bC-dEf-ghIj"</b>
                   	 	<br/><br/>
                   	 	Sample Output :  <b>"j-Ih-gfE-dCba"</b>
                   	 	
                   	</p>
                          <p  class="subscrollcoll"> Sample Input :  
                   	<br/><b>"Test1ng-Leet=code-Q!"</b>
                   	<br/><br/>
                   	Sample Output :  <b>"Qedo1ct-eeLg=ntse-T!"</b>
                   	</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/reverse-only-letters-code.jsp" %>
