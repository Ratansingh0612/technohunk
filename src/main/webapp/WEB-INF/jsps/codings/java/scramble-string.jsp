...
<head>
    ...
    <title>${companyName} -Sort Color Problem </title>
    <!--[if lt IE 9]>
...
Below is one possible representation of s1 = "great":
                  <br/><br/>
                    <img src="${pageContext.request.contextPath}/images/codings/scramble-string-1.png">
                   </p>
                   
                         <p  class="subscrollcoll"> 
                    <img src="${pageContext.request.contextPath}/images/codings/scramble-string-2.png">
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/scramble-string-code.jsp" %>
