...
<head>
    ...
    <title>${companyName} -Diamond Pattern Problem</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/diamond-pattern-problem.png">
                   ...
                   <p  class="subscrollcoll"> Sample Input :  4</p>
                         <p  class="subscrollcoll"> Sample Output :  You have to print the pattern as described in Problem Statement</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/diamond-pattern-code.jsp" %>
