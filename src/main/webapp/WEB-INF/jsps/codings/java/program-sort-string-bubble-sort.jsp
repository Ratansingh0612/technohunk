...
<head>
    ...
    <title>${companyName} -Sort string using Bubble sort</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/bubble-sort.png">
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/program-sort-bubble-sort-code.jsp" %>
