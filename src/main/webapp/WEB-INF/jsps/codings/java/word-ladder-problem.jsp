...
<head>
    ...
    <title>${companyName} -Word Ladder Problem</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/word-ladder-problem.png">
                       </p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/word-ladder-code.jsp" %>
