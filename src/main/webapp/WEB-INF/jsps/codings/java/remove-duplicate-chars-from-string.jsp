...
<head>
    ...
    <title>${companyName} -Remove duplicate characters from String</title>
    <!--[if lt IE 9]>
        ...
        <div class="container" style="background-color: white;">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                   ...
                   <p  class="probscrollcoll"> Given a string , remove duplicate characters and print the final string. </p>
                   
                   <p  class="subscrollcoll"> Sample Input :  Thiiis is aa tessstt ssstring</p>
                      <p  class="probscrollcoll"> Sample Output : This is a test string</p>
                   <p  class="subscrollcoll"> Sample Input :  thisss neverrr cooomes</p>
                      <p  class="probscrollcoll"> Sample Output : this never comes</p>
                    </div>
                </div>
                <!-- END / BLOG LIST -->
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/remove-duplicate-characters-code.jsp" %>
