...
<head>
    ...
    <title>${companyName} -Fizz Buzz Problem!</title>
    <!--[if lt IE 9]>
        ...
        <div class="container" style="background-color: white;">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                   ...
                   <p  class="probscrollcoll"> Sample Input :  15</p>
                         <p  class="subscrollcoll"> Sample Output :  fizzbuzz</p>
                         
                           <p  class="probscrollcoll"> Sample Input :  57</p>
                         <p  class="subscrollcoll"> Sample Output :  fizz</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/fizz-buzz-code.jsp" %>
