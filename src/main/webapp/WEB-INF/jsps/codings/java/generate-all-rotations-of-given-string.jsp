...
<head>
    ...
    <title>${companyName} -Lexicographical concatenation of all substrings of a string</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <b>Generate all rotations of a given string</b>
                          <br/>
                         
                          <img src="${pageContext.request.contextPath}/images/codings/generate-all-rotations.png">
                   ...
                   <p  class="subscrollcoll"> Sample Input :  
                   	<b>abc</b></p>
                         <p  class="subscrollcoll"> Sample Output :  abc bca cab</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/generate-rotate-string-code.jsp" %>
