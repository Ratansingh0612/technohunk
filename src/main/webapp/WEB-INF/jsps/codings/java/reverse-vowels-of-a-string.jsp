...
<head>
    ...
    <title>${companyName} - Reverse Vowels of a String</title>
    <!--[if lt IE 9]>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/reverse-vowels-string-code.jsp" %>
