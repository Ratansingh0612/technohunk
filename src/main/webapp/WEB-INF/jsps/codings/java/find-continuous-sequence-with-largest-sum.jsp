...
<head>
    ...
    <title>${companyName} -Find continuous sequence with largest sum!</title>
    <!--[if lt IE 9]>
        ...
        <div class="container" style="background-color: white;">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                   ...
                   <p  class="probscrollcoll"> Given an array of integers print the largest sum.</p>
                   
                   <p  class="subscrollcoll"> Sample Input :  <b>2 &nbsp;&nbsp; -8 &nbsp;&nbsp; 3&nbsp;&nbsp;  -2&nbsp;&nbsp;  4&nbsp;&nbsp;  -10</b></p>
                        <p  class="probscrollcoll"> Sample Output :  <b>5</b> 
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/find-continous-max-code.jsp" %>
