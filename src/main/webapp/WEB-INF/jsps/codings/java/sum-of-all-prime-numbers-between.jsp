...
<head>
    ...
    <title>${companyName} -Sum of all prime numbers between two numbers!</title>
    <!--[if lt IE 9]>
...
Example : 2, 3, 5, 7, 11, 13, 17......<br/>
Note : 0 and 1 are not prime numbers.
Find The Sum Of All Prime Numbers Between Two Given Numbers .
Example-
If start value =50 and 
end value =100 then
The sum of all prime numbers between 50 and 100 =732 (53+59+61+67+71+73+79+83+89+97)

                           
                         </p>
                   
                   <p  class="subscrollcoll"> Sample Input : <br/> 50<br/> 100</p>
                         <p  class="probscrollcoll"> Sample Output :  732</p>
                    </div>
                </div>
                <!-- END / BLOG LIST -->
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/sum-of-all-prime-code.jsp" %>
