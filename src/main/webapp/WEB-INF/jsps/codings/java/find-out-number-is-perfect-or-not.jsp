...
<head>
    ...
    <title>${companyName} -Find out number is perfect or not</title>
    <!--[if lt IE 9]>
        ...
        <div class="container" style="background-color: white;">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                   ...
                   <p  class="probscrollcoll"> Given a number , find number is perfect or not ,perfect then print yes and else print no.</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/find-out-number-is-perfect-code.jsp" %>
