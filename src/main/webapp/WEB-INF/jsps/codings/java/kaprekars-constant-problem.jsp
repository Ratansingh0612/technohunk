...
<head>
    ...
    <title>${companyName} -Kaprekars Constant Problem</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                       ...
                       <b>Your program should return the number of times this routine must be performed until 6174 is reached.</b> 
                   ...
                   <p  class="subscrollcoll"> Sample Input :  2111 , Sample Output :  5</p>
                         <p  class="subscrollcoll"> Sample Input :  9831 , Sample Output :  7</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/kaprekars-constant-code.jsp" %>
