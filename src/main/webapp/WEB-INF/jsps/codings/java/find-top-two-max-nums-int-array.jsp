...
<head>
    ...
    <title>${companyName} - Find top two max nums int array</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/array-declaration.png">
                         </p>
                   <p  class="scrollcoll"> Given an int array , print top two max number.</p>
                   
                   <p  class="probscrollcoll"> Sample Input :  5 &nbsp;&nbsp;81&nbsp;&nbsp;  65&nbsp;&nbsp;  72&nbsp;&nbsp;  62&nbsp;&nbsp;  10  &nbsp;&nbsp;67 &nbsp;&nbsp; 98&nbsp;&nbsp;  23 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  (array of integers separated by space) </p>
                         <p  class="subscrollcoll"> Sample Output :  98&nbsp;&nbsp; 81</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/find-top-two-max-nums-int-array-code.jsp" %>
