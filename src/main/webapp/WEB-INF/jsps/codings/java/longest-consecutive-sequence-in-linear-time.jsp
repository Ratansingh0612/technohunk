...
<head>
    ...
    <title>${companyName} -Longest Consecutive Sequence in O(n)</title>
    <!--[if lt IE 9]>
...
For example, given [100, 4, 200, 1, 3, 2], the longest consecutive elements sequence should be [1, 2, 3, 4]. Its length is 4.
                   	...
                   	<p  class="probscrollcoll"> Sample Input :
                   		<br/> 
                   		100 &nbsp;  4&nbsp;   200&nbsp;   1 &nbsp;  3 &nbsp;  2 &nbsp;                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -> input int arrays
                   		</p>
                         ...
                         <br/>  
                        	<p  class="probscrollcoll"> Sample Input :
                   		<br/> 
                   		4 &nbsp;  200&nbsp;   1&nbsp;   2 &nbsp; 300 &nbsp; 301 &nbsp; 302 &nbsp; 310 &nbsp;                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -> input int arrays
                   		</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/longest-consecutive-sequence-in-linear-time-code.jsp" %>
