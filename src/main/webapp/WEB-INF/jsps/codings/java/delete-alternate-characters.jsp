...
<head>
    ...
    <title>${companyName} -Delete Alternate Characters from string</title>
    <!--[if lt IE 9]>
...
Note that 0 is even, so index 0 is even index.
 
                          
                         </p>
                   
                   <p  class="subscrollcoll"> Sample Input :  Geeks , Sample Output :  Ges</p>
                         <p  class="subscrollcoll"> Sample Input :  GeeksforGeeks , Sample Output :  GesoGes</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/delete-alternate-chars-code.jsp" %>
