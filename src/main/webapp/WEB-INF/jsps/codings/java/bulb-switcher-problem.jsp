...
<head>
    ...
    <title>${companyName} -Bulb Switcher Problem11</title>
    <!--[if lt IE 9]>
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          ...
                          <img src="${pageContext.request.contextPath}/images/codings/bulb-switch.png">
                          There are n bulbs that are initially off. You first turn on all the bulbs. Then, you turn off every second bulb. On the third round, you toggle every third bulb (turning on if it's off or turning off if it's on). For the i-th round, you toggle every i bulb. For the n-th round, you only toggle the last bulb. Find how many bulbs are on after n rounds.
                          
                          <a target="_blank" href="http://aresou.net/post/7/summary-thinking-on-bulb-switcher-problem">Read More</a>
...
<br/>
Input: 3</p>
<p  class="subscrollcoll">Output: 1 </p>
<p  class="probscrollcoll">Explanation: 
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/bulb-switcher-code.jsp" %>
