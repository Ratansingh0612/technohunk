...
<br/> <br/> 
                     <img src="${pageContext.request.contextPath}/images/codings/robot_maze.png"><br/> 
                     <b>Note:</b> m and n will be at most 100.
                      </p>
                   
                    <p  class="probscrollcoll"> <b>Input Format </b>  <br/>  
                   		The first line integer represent number of columns <b>m</b> &
                   		The second line integer represent number of rows <b>n</b>
                   		<br/>		<br/>
                   </p>
                   
                   
                   <p  class="probscrollcoll"><b>Ex-1</b><br/>
                   	  <img src="${pageContext.request.contextPath}/images/codings/robot-unique-paths.png"><br/> 
                   	 Sample Input :
...
3. Down -> Right -> Right<br/>
                      ...
                      <p  class="probscrollcoll"><b>Ex-2</b><br/> 
                        <img src="${pageContext.request.contextPath}/images/codings/robot_maze.png"><br/>
                         Above is a 7 x 3 grid. How many possible unique paths are there?<br/><br/>
                        <br/> 
                   	 Sample Input :
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/unique-paths-problems-code.jsp" %>
