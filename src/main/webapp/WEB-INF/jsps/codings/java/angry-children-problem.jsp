...
<head>
    ...
    <title>${companyName} -Angry Children Problem </title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                   ...
                   <p  class="probscrollcoll">
                     <img src="${pageContext.request.contextPath}/images/codings/angry-children-problem.jpg">
                    <b>Bill Gates</b> is on one of his philanthropic journeys to a village in Utopia. <br/>He has N packets of candies and
would like to distribute one packet to each of the K children in the village (each packet may contain
different number of candies). To avoid any fighting among the children, he would like to pick K out of N
...
max(x1,x2,...xk) - min(x1,x2,...xk) where max denotes the highest value amongst the elements, and min
denotes the least value amongst the elements. Can you figure out the minimum unfairness and print it?

                   
                   </p>
                   
                    <p  class="probscrollcoll"> <b>Input/Output Format :</b>  <br/>  
                   		First Line contains number of children
                   		<br/>	
                   		Second line contains integers array that denotes the candy in each packet.
                   ...
                   <p  class="probscrollcoll"> Sample Input :
                         ...
                         <p  class="subscrollcoll"> Sample Output :  20</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/angry-children-code.jsp" %>
