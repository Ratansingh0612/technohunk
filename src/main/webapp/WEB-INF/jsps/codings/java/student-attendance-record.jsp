...
<head>
    ...
    <title>${companyName} - Student Attendance Record </title>
    <!--[if lt IE 9]>
...
1. <b>'A'</b> : Absent.<br/>
2. <b>'L'</b> : Late. <br/>
3. <b>'P'</b> : Present. <br/> <br/>

A student could be rewarded if his attendance record doesn't contain 
<b>more than one 'A' (absent) or more than two continuous 'L' (late).</b>
<br/> <br/>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/student-attendance-record-code.jsp" %>
