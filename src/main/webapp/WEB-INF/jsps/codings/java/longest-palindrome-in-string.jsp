...
<head>
    ...
    <title>${companyName} -Longest Palindrome In String</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/palindrome-string.png">
                           Palindrome string is a string that reads the same backward as forward and can be of odd or even length. A palindrome number is a number which is equal to its reverse.
                         </p>
                   <p  class="scrollcoll"> Given a string , print longest possible palindrome.</p>
                   <p  class="probscrollcoll"> Sample Input :  ueyetyeteradar0192929</p>
                         <p  class="subscrollcoll"> Sample Output :  radar</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/find-longest-palindrome-code.jsp" %>
