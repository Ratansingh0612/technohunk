...
<head>
    ...
    <title>${companyName} -Largest number problem</title>
    <!--[if lt IE 9]>
        ...
        <div class="container" style="background-color: white;">
           ...
           Given a list of non negative integers, arrange them such that they form the largest number.
                   ...
                   <p  class="probscrollcoll"> Sample Input :
                   		<br/>  
                   		10 &nbsp;  2                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -> input int arrays
                   		</p>
                         <p  class="subscrollcoll">Sample Output :  210</p>
                         
                         <br/>  
                         <p  class="probscrollcoll"> Sample Input :
                   		3 &nbsp;  10&nbsp;   34&nbsp;5&nbsp;9                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -> input int arrays
                   		</p>
                         <p  class="subscrollcoll">Sample Output : 9534330</p>
                          ...
                          <p  class="probscrollcoll"> <b>Explanation :</b>
                   		<br/>  
                   		Test case1: 
                   	For Input array : 10 &nbsp;2 ,possible numbers are 102,120,12,21,201,210 so max number is 210
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/largest-number-problem-code.jsp" %>
