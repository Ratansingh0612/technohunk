            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                         <img src="${pageContext.request.contextPath}/images/codings/time-conversion.png">
                         <br/>
                      Given a time in 12-hour AM/PM format, convert it to military (24-hour) time.
<br/><br/>
<b>Note:</b> Midnight is 12:00:00AM on a 12-hour clock, and 00:00:00 on a 24-hour clock. Noon is 12:00:00PM on a 12-hour clock, and 12:00:00 on a 24-hour clock.         <br/><br/>
                         </p>
  ...
  <p  class="probscrollcoll"><b>Output Format</b> :  	<br/>
 	Convert and return the given time in 24-hour format, where 00 <= hh <= 23.
                   ...
                   <p  class="subscrollcoll"> Sample Input1 :  
                   	<br/><b>"07:05:45PM"</b>
                   	<br/><br/>
                   	Sample Output1 :  <b>"19:05:45"</b>
                 	</p>
               <p  class="subscrollcoll"> Sample Input2 :  
                   	<br/><b>"12:40:22AM"</b>
                   	<br/><br/>
                   	Sample Output2 :  <b>"00:40:22"</b>
                   	...
                   	<br/><b>"12:05:39AM"</b>
                   	<br/><br/>
                   	Sample Output4 :  <b>"00:05:39"</b>
                     	
                   	</p>
                   	  <p  class="subscrollcoll"> Sample Input5:  
                   	<br/><b>"02:34:50PM"</b>
                   	<br/><br/>
                   	Sample Output5 :  <b>"14:34:50"</b>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/time-conversion-code.jsp" %>
