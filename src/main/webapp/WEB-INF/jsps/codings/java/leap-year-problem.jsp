...
<head>
    ...
    <title>${companyName} -Leap Year problem </title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                         <img src="${pageContext.request.contextPath}/images/codings/leap-year.png">
                        A leap year is a year which contains 366 day, which is 1 day more of normal 365 day year.
 					 	Leap year comes in a interval of 4 years. In Gregorian calendar in leap year February has 29 days which is 1 day more than 28 day in normal year.
                          </p>
                    <p  class="probscrollcoll"> Given a number , print Yes if it is leap year, print No otherwise.</p>
                   <p  class="subscrollcoll"> Sample Input :  2000  , Sample Output :  Yes</p>
                         
                           <p  class="probscrollcoll"> Sample Input :  2012 , Sample Output :  Yes </p>
                           <p  class="subscrollcoll"> Sample Input :  1900 , Sample Output :  No</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/leap-year-problem-code.jsp" %>
