...
<head>
    ...
    <title>${companyName} -Find Number is odd or even  without modulus operator</title>
    <!--[if lt IE 9]>
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="probscrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/even-odd-number.png">
                        </p>
                   <p  class="subscrollcoll"> Given a number , find number is odd or even ,number is odd print yes and else print no.</p>
                     <p  class="probscrollcoll"> Given a binary number , print decimal representation of it.</p>
                          <p  class="subscrollcoll">
                    Sample Input :  999	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;, 			 Sample Output : yes
                   </p>
                   
                                     
                                      <p  class="subscrollcoll">
                    Sample Input :  440	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;,			  Sample Output : no
                   </p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/odd-even-code.jsp" %>
