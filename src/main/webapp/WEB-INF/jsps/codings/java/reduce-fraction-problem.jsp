...
<head>
    ...
    <title>${companyName} -Reduce Fraction Problem</title>
    <!--[if lt IE 9]>
...
Example-
8/12 =2/3 , 5/25=1/5 , 9/21=3/7
You have to enter numerator and denominator of a fraction and print the reduced form.
                         
                           
                         </p>
                   
                   <p  class="subscrollcoll"> Sample Input :  <br/>2500<br/> 50</p>
                         <p  class="subscrollcoll"> Sample Output :  50/1</p>
                         
                          <p  class="subscrollcoll"> Sample Input :   <br/>9  <br/>21</p>
                         <p  class="subscrollcoll"> Sample Output :  3/7</p>
                    </div>
                </div>
                <!-- END / BLOG LIST -->
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/reduce-fractional-code.jsp" %>
