...
<head>
    ...
    <title>${companyName} -Add Digits Problem!</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/digit-number.png">
                         .(Wikipedia)</p>
                   <p  class="probscrollcoll"> Given a non-negative integer num, repeatedly add all its digits until the result has only one digit.</p>
                   
                   <p  class="subscrollcoll"> Sample Input :  <b>38</b> , Sample Output :  <b>2</b></p>
                   <p  class="scrollcoll">
                    <b>Explanation:</b> The process is like: 3 + 8 = 11, 1 + 1 = 2. 
             		Since 2 has only one digit, return it.
                   </p>
                   
                        <p  class="probscrollcoll"> Sample Input :  <b>82</b>  , Sample Output :  <b>1</b> </p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/add-digits-problem-code.jsp" %>
