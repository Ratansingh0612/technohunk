            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <br/> <br/>
                   A peak element is an element that is greater than its neighbors.<br/><br/>
Given an input array nums, where nums[i] not equal nums[i+1], find a peak element and return its index.<br/><br/>
The array may contain multiple peaks, in that case return the index to any one of the peaks is fine.<br/><br/>
You may imagine that nums[-1] = nums[n] = infinite value.<br/><br/>
                                 </p>
  ...
  <p  class="probscrollcoll"><b>Output Format</b> :  	<br/>
 	 Return a integer value as per problem statement.
               ...
               <p  class="subscrollcoll"> Sample Input :  
                   	...
                   	<b>Explanation:</b> 3 is a peak element and your function should return the index number 2.
                   	   ...
                   	   <p  class="subscrollcoll"> Sample Input :  
                   	<br/><b>1&nbsp;&nbsp;2&nbsp;&nbsp;1&nbsp;&nbsp;3&nbsp;&nbsp;5&nbsp;&nbsp;6&nbsp;&nbsp;4</b>
                   	<br/><br/>
                   	Sample Output :  <b>1 or 5</b><br/>
                   	<b>Explanation:</b> Your function can return either index number 1 where the peak element is 2, 
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/find-peak-element-code.jsp" %>
