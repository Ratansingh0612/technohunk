...
<head>
    ...
    <title>${companyName} -Cube Root of a Number!</title>
    <!--[if lt IE 9]>
        ...
        <div class="container" style="background-color: white;">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <img src="${pageContext.request.contextPath}/images/codings/cubedRoot.gif">
                    <br/><b>Given a number n, find the cube root of n..</b></p>
                   
                   <p  class="subscrollcoll"> Sample Input :  <b>27</b> , Sample Output :  <b>3</b></p>
                        <p  class="probscrollcoll"> Sample Input :  <b>3</b>  , Sample Output :  <b>1.442250</b> </p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/cube-root-code.jsp" %>
