...
<div id="page-wrap">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                         <img src="${pageContext.request.contextPath}/images/codings/robbers.jpg">
                         <br/>
                        You are a professional robber planning to rob houses along a street. Each house has a certain amount of money stashed. All houses at this place are arranged in a circle. That means the first house is the neighbor of the last one. Meanwhile, adjacent houses have security system connected and <b>it will automatically contact the police if two adjacent houses were broken into on the same night</b>.
  <br/> <br/>
  Given a list of non-negative integers representing the amount of money of each house, determine the maximum amount of money you can rob tonight <b>without alerting the police</b>.
                   	...
                   	<br/>
                   		A single line, given a array of non-negative integers representing the amount of money of each house
						</p>
...
determine the maximum amount of money you can rob tonight without alerting the police.
                   ...
                   <p  class="subscrollcoll">Sample Input :  
                   	...
                   	<b>Explanation</b><br/>
            	You cannot rob house 1 (money = 2) and then rob house 3 (money = 2),<br/>
             because they are adjacent houses.
                   	...
                   	<b>1 &nbsp;&nbsp;2&nbsp;&nbsp; 3&nbsp;&nbsp; 1</b><br/>
                   	<br/><br/>
                   	Sample Output :  <b>4</b><br/><br/>
                   	<b>Explanation</b><br/>
            	Rob house 1 (money = 1) and then rob house 3 (money = 3).<br/>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/house-robber-code.jsp" %>
