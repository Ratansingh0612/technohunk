...
<head>
    ...
    <title>${companyName} -Pentagonal Number Problem</title>
    <!--[if lt IE 9]>
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          ...
                          Using the Java language, have the function PentagonalNumber(n) read n which will be a positive integer and determine how many dots exist in a pentagonal shape around a center dot on the nth iteration. For example, in the image below you can see that on the first iteration there is only a single dot, on the second iteration there are 6 dots, on the third there are 16 dots, and on the fourth there are 31 dots. 
                          <img src="${pageContext.request.contextPath}/images/codings/pentagonal-problem.png">
                          
                         </p>
                   
                   <p  class="subscrollcoll"> Sample Input :  2 , Sample Output :  6</p>
                         <p  class="subscrollcoll"> Sample Input :  5 , Sample Output :  51</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/pentagonal-problem-code.jsp" %>
