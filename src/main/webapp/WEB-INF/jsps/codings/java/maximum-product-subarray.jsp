...
<head>
    ...
    <title>${companyName} -Maximum product subarray</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                Given an integer array nums, find the contiguous subarray within an array (containing at least one number) which has the largest product.
                   ...
                   <p  class="probscrollcoll"> Sample Input :
                   		<br/>  
                   		2&nbsp; 3&nbsp; -2&nbsp; 4                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -> input int arrays
                   		</p>
                         <p  class="subscrollcoll"> Sample Output : 6</p>
                         
                          <p  class="probscrollcoll"> Sample Input :
                   		<br/>  
                   		 -2 &nbsp;0 &nbsp;-1                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -> input int arrays
                   		</p>
                         <p  class="subscrollcoll"> Sample Output : 0</p>
                          ...
                          <p  class="probscrollcoll"> <b>Explanation :</b>
                   		...
                   		Input: [2,3,-2,4]
Output: 6<br/>
<b>Reason:</b> [2,3] has the largest product 6.
                   		</p>
                   		...
                   		Input: [-2,0,-1]
Output: 0<br/>
<b>Reason:</b> The result cannot be 2, because [-2,-1] is not a subarray.
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/maximum-product-subarray-code.jsp" %>
