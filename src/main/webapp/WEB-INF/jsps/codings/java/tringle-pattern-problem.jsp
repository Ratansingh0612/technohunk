...
<head>
    ...
    <title>${companyName} -Tringle Pattern Problem</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/tringle-pattern-problem.png">
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/tringle-pattern-code.jsp" %>
