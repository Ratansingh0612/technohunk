            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <br/>
                        Given a string, your task is to count how many palindromic substrings in this string. <br/>  <br/>
                    The substrings with different start indexes or end indexes are counted as different substrings even they consist of same characters.       </p>
                             <p  class="probscrollcoll"><b>Input Format</b> :  
                   	<br/>
					String as an input       
			</p>
  <p  class="probscrollcoll"><b>Output Format</b> :  	<br/>
 	return total number palindromic substrings
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/palindromic-substrings-code.jsp" %>
