...
<head>
    ...
    <title>${companyName} -Check String All Unique Characters</title>
    <!--[if lt IE 9]>
        ...
        <div class="container" style="background-color: white;">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                   ...
                   <p  class="probscrollcoll"> Given a string , print "Yes" if string all characters are unique, print "No" otherwise.</p>
                   
                   <p  class="subscrollcoll"> Sample Input :  abcrtepko , Sample Output : Yes</p>
                   <p  class="probscrollcoll"> Sample Input :  tomorrow , Sample Output : No </p>
                    </div>
                </div>
                <!-- END / BLOG LIST -->
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/check-string-all-unique-characters-code.jsp" %>
