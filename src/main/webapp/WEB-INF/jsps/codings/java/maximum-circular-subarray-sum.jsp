...
<head>
    ...
    <title>${companyName} -Maximum circular subarray sum</title>
    <!--[if lt IE 9]>
        ...
        <div class="container" style="background-color: white;">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                   ...
                   <img src="${pageContext.request.contextPath}/images/codings/max-sum-array.jpg" style="height:180px;"/>
                    <br/> <br/>
                	Given n numbers (both +ve and -ve), arranged in a circle, find the maximum sum of consecutive number.
                            <br/>
                            <img src="${pageContext.request.contextPath}/images/codings/maximum-circle-icon.png"/>
                   ...
                   <p  class="probscrollcoll"> Sample Input :
                   		...
                   		8&nbsp; -8&nbsp; 9&nbsp; -9&nbsp; 10&nbsp; -11&nbsp; 12              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -> input int arrays
                   		</p>
                         <p  class="subscrollcoll"> Sample Output : 22</p>
                         
                          <p  class="probscrollcoll"> Sample Input :
                   		<br/>  
                   		 10&nbsp; -3&nbsp; -4&nbsp; 7&nbsp; 6&nbsp; 5&nbsp; -4&nbsp; -1               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -> input int arrays
                   		</p>
                         <p  class="subscrollcoll"> Sample Output : 23</p>
                         
                         <p  class="probscrollcoll"> Sample Input :
                   		<br/>  
                   		
                   	
                   		 	1&nbsp; 40&nbsp; -14&nbsp; 7&nbsp; 6&nbsp; 5&nbsp; -4&nbsp; -1             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -> input int arrays
                   		</p>
                         <p  class="subscrollcoll"> Sample Output : 52</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/maximum-circular-subarray-sum-code.jsp" %>
