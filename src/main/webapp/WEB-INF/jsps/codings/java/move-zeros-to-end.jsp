...
<head>
    ...
    <title>${companyName} -Move zeros to end</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
         Separate zeros from non-zeros in an integer array and move them to end of the array.
Order of occurance of non zero elements should not be changed.
For example-
If Input Array={ 12  0  7  0  8  0  3} then
 After moving zeros to end the imput  array will be
{12, 7, 8, 3, 0, 0, 0}
                   ...
                   <p  class="subscrollcoll">
                    Sample Input :  12 &nbsp;&nbsp; 0 &nbsp;&nbsp; 7 &nbsp;&nbsp; 0 &nbsp;&nbsp; 8 &nbsp;&nbsp; 0&nbsp;&nbsp;  3 
                     ...
                     <span style="margin-left:100px;">= > Integers array separated by space</span>
                   </p>
                   <p  class="probscrollcoll">
                    Sample Output :  12&nbsp;&nbsp; 7&nbsp;&nbsp; 8&nbsp;&nbsp; 3&nbsp;&nbsp; 0&nbsp;&nbsp; 0&nbsp;&nbsp; 0
                    </p>
                   <p  class="subscrollcoll"> Sample Input :  1 &nbsp;&nbsp; -5 &nbsp;&nbsp; 0  &nbsp;&nbsp;0&nbsp;&nbsp;  8 &nbsp;&nbsp; 0 &nbsp;&nbsp;1  
                   <span style="margin-left:100px;">= > Integers array separated by space</span>
                   </p>
                   
                    <p  class="probscrollcoll">
                    Sample Output :  1  &nbsp;&nbsp;-5 &nbsp;&nbsp; 8 &nbsp;&nbsp; 1&nbsp;&nbsp;  0  &nbsp;&nbsp;0 &nbsp;&nbsp; 0
                    </p>
                    </div>
                </div>
                <!-- END / BLOG LIST -->
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/move-to-zero-end-code.jsp" %>
