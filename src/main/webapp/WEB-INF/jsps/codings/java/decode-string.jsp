            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <br/>
                        Given an encoded string, return it's decoded string.  <br/>  <br/>
  ...
  <p  class="probscrollcoll"><b>Output Format</b> :  	<br/>
 	 Return String output as per the problem described in above problem statement.
               ...
               <p  class="subscrollcoll"> Sample Input :  
                   	<br/><b>"3[a]2[bc]"</b>
                   	<br/><br/>
                   	Sample Output :  <b>"aaabcbc"</b>
                   	</p>
                               <p  class="probscrollcoll"> Sample Input :  
                   	<br/><b>"3[a2[c]]"</b>
                   	 	<br/><br/>
                   	 	Sample Output :  <b>"accaccacc"</b>
                   	 	
                   	</p>
                   	
                   	 <p  class="probscrollcoll"> Sample Input :  
                   	<br/><b>"2[abc]3[cd]ef"</b>
                   	 	<br/><br/>
                   	 	Sample Output :  <b>"abcabccdcdcdef"</b>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/decode-string-code.jsp" %>
