...
<head>
    ...
    <title>${companyName} -Pangrams Problem</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <%-- <img src="${pageContext.request.contextPath}/images/codings/armstrong-number.png"> --%>
                          Roy wanted to increase his typing speed for programming contests. So, his friend advised him to type the sentence "The quick brown fox jumps over the lazy dog" repeatedly, because it is a pangram. (Pangrams are sentences constructed by using every letter of the alphabet at least once.)
                        </p>
                   <p  class="probscrollcoll"> Given a string , print "Yes"  if string is a pangrams, print "No" otherwise.</p>
                   
                   <p  class="subscrollcoll"> Sample Input :  "We promptly judged antique ivory buckles for the next prize"  => Sample Output :  Yes</p>
                   <p  class="probscrollcoll"> Sample Input :  "We promptly judged antique ivory buckles for the prize" => Sample Output :  No</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/pangrams-code.jsp" %>
