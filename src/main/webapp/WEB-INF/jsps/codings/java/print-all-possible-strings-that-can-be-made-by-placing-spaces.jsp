...
<head>
    ...
    <title>${companyName} -Reverse Linked List Problem</title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                         ...
                         <p  class="scrollcoll">
                          <img src="${pageContext.request.contextPath}/images/codings/print-all-possible.png">
                           <span style="float: right;">
                           (${applicationScope.companyName})
                           </span>
                         </p>
                        
                   <p  class="probscrollcoll"> Write your own code to print all possible strings that can be made by placing spaces.</p>
