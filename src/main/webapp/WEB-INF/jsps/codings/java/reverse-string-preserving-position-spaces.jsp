...
<head>
    ...
    <title>${companyName} -Reverse string preserving position spaces</title>
    <!--[if lt IE 9]>
        ...
        <div class="container" style="background-color: white;">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                   ...
                   <p  class="probscrollcoll"> For example, if "I Am Not String" is the given string then the reverse of this string with preserving the position of spaces is "g ni rtS toNmAI"..</p>
                   
                   <p  class="probscrollcoll"> Sample Input : I Am Not String</p>
                         <p  class="subscrollcoll"> Sample Output :  g ni rtS toNmAI</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/preserving-position-spaces-code.jsp" %>
