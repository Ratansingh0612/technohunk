...
<head>
    ...
    <title>${companyName} -Angle between hour and minute hand</title>
    <!--[if lt IE 9]>
                ...
                <div class="col-md-8">
                    <div class="blog-list-content">
                   	  <!-- POST -->
                          ...
                          <table>
                          	<tr>
                          		<td> <img src="${pageContext.request.contextPath}/images/codings/angle-between-hour-minutes.jpg"></td>
                          		<td style="font-size: 17px;">This problem is know as Clock angle problem where we need to find angle between hands of an analog clock at a given time.</td>
                          	</tr>
                          </table>
                   ...
                   <span style="margin-left:300px;">= > hours, minutes</span>
                    </p> 
                   <p  class="subscrollcoll">
                   	Sample Output :  165  <span style="margin-left:200px;">= > degree</span>
                   </p>
                   ...
                   <span style="margin-left:300px;">= > hours, minutes</span>
                     ...
                     <p  class="subscrollcoll">
                   	Sample Output :  75  <span style="margin-left:200px;">= > degree</span>
                   </p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/angle-between-code.jsp" %>
