...
<head>
    ...
    <title>${companyName} -Two Sum problem in O(n)-</title>
    <!--[if lt IE 9]>
...
If sum of any two different numbers is not equal to target then return indices are  [0, 0].
                 
                             </p>
                              <p  class="probscrollcoll"> 
                             <b>Input format-</b>
First line integer value represents target value and second line input integers represent array elements
</p>
 <p  class="probscrollcoll"> 
<b>Output format-</b>
Print the two indices corresponding to both numbers within a bracket
</p>                             
                   	...
                   	<p  class="probscrollcoll"> Sample Input :
                   		...
                   		9 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -> target value
                   		<br/> 
                   		2 &nbsp;  7&nbsp;   11&nbsp;   14 &nbsp;                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -> input int arrays
                   		</p>
                         <p  class="subscrollcoll">Sample Output :  [0,1]</p>
                         ...
                         <p  class="subscrollcoll">Sample Output :  [0,0]</p>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/two-sum-problem-in-linear-time-code.jsp" %>
