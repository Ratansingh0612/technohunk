...
<head>
    ...
    <title>${companyName} -Grading Students Problem </title>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                   ...
                   <p  class="probscrollcoll">
                     <img src="${pageContext.request.contextPath}/images/codings/student-grade.gif">
                <br/> 
               WonderLand University has the following grading policy:<br/>  <br/> 
...
Sam is a professor at the university and likes to round each student's grade according to these rules:<br/> <br/>
               If the difference between the grade and the next multiple of 8 is less than 3, round grade up to the next multiple of 5.<br/>
...
Given the initial value of grade for each of Sam's n students, write code to automate the rounding process.<br/>
                    ...
                    <p  class="probscrollcoll"> <b>Input Format </b>  <br/>  
                   		Input Format :
				Array of grades of n students where grades[i], denoting student i's grade.
...
0 <= grades[i] <= 100
                   ...
                   <p  class="probscrollcoll"><b>Ex-1</b>
                   	 Sample Input :
                         ...
                         <p  class="subscrollcoll"> Sample Output :  75&nbsp;&nbsp; 67&nbsp;&nbsp; 40&nbsp;&nbsp; 33</p>
                         
                         <p  class="probscrollcoll"> <b>Explanation :</b>
                   		<br/>
                 1. Student 1 received a 73, and the next multiple of 5 from 73 is 75. Since 75 - 73 < 3, the student's grade is rounded to 75.
                 <br/>
2. Student 2 received a 67, and the next multiple of 5 from 67 is 70. Since 70 - 67 = 3, the grade will not be modified and the student's final grade is 67.<br/>
3. Student 3 received a 38, and the next multiple of 5 from 38 is 40. Since 40 - 38 < 3, the student's grade will be rounded to 40.<br/>
...
<!-- Load jQuery -->
  ...
  <%@include file="/dcode/java/grading-student-code.jsp" %>
