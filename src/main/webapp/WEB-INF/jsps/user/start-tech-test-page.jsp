...
<div id="page-wrap">
 ...
 <%--    <%@include file="profile-feature.jsp" %> --%>
    ...
    <!-- COURSE CONCERN -->
  <section style="padding-top: 0px;background-color: white;min-height: 580px; font-size: 18px;padding-bottom: 30px;font-family: 'Lato', sans-serif;" id="quizz-intro-section" >
        <div class="container">
...
<!-- 					     </tr> -->
					      ...
					      <tr>
                            ...
                            <div class="pad_left1">
              <span style="font-family: 'Lato', sans-serif;font-size: 16px;"> &nbsp;&nbsp;&nbsp;Question List(${fn:length(sessionScope.questionsMapForTest)}) : <img alt="" src="${pageContext.request.contextPath}/images/question2.png" width="20px;"></span>
            </div>
             <br/>
          ...
          <p/>
           ...
           <!--  <a href="#" class="button"><span><span>Read More</span></span></a> -->
            <div class="pad_left1">
                 ...
                 <b style="font-family: 'Lato', sans-serif;font-size: 15px;">About Square Color <img alt="" src="${pageContext.request.contextPath}/images/info.png"></b>
           		   <p style="font-family: 'Lato', sans-serif;font-size: 15px; color: black;">
