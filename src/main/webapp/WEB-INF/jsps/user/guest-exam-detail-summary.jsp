...
<div id="page-wrap">
 ...
 <!-- PRELOADER -->
  ...
  <section style="padding-top: 0px;padding-bottom:10px;background-color: white;" id="quizz-intro-section" class="quizz-intro-section learn-section">
        ...
        <div class="container">
        				 <h3 style="font-size: 18px;background-color:#82a7c5;color:white;">
                ...
                <img src="${pageContext.request.contextPath}/images/icon/writing-icon.png" style="height: 40px;"/>
						<span style="background-color: #ff0000c9;margin-left: 20px;font-size: 17px;">
						   Wrong Answer -  ${testConfiguration.totalMarks-testConfiguration.secureMarks}
						</span>	
							<span style="background-color: #0ef37a;margin-left: 40px;font-size: 17px;">
						  	  Correct Answer -  ${testConfiguration.secureMarks}
						</span>	
						<span style="background-color: #efbbdb;margin-left: 40px;font-size: 17px;">
						  	  Questions Set(s)  : ${questionSet}
						</span>	
						<div style="float: right">
							  <span style="background-color: #c3e7d4;font-size: 17px;">Total Questions :</span><b style="background-color: yellow;margin-right: 10px;">${fn:length(questionList)}</b>
						</div>
			...
			<form  id="addQToConfigureTest" action="${pageContext.request.contextPath}/action/add-qconfigure-test" method="post">
					...
					<tr>
						<td  colspan=3 height="30" style="color: black;font-size: 16px;">
								<span id="questionTextId" style="color:black;font-weight: bolder;"><b>${status.count} .</b>&nbsp;<img src="${pageContext.request.contextPath}/images/pquestion.png"/>${question.questionText}</span>
						</td>
					</tr>
					<tr>
