...
<div id="page-wrap">
 ...
 <%--    <%@include file="profile-feature.jsp" %> --%>
    ...
    <!-- COURSE CONCERN -->
  <section style="padding-top: 0px;background-color: white;" id="quizz-intro-section" >
        <div class="container">
            <div class="title-ct">
            	 <hr/>
                 &nbsp;&nbsp;<span style="color: black"> 
                 		<img src="${pageContext.request.contextPath}/images/exam-summary.png" style="height:40px;"/> - 
					     	   ...
					     	   Technology : &nbsp;&nbsp;&nbsp;<span  id="ttech" style="color:black;font-weight: bold;">${utechName}</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	 Test Name :&nbsp;&nbsp;&nbsp; <span  id="ttech" style="color:black;font-weight: bold;">${utestName}</span> 
           ...
           <input type="hidden" id="questionText" name="questionText" value="${questionAndAnsTestDataVO.questionId}"/>
            <div class="bloading" >
                <table class="table table-bordered" style="width: 120%;">
                        <tr><td>
                        <table id="optionTable" border="0"     cellpadding="2px" cellspacing="1px" style="margin-top: 0px;">
                         ...
                         <tr align="left">
					     	<td  colspan="2" align="right" style="margin-top: 20px;">&nbsp;&nbsp;
					     		...
					     		<b>Question: <span id="currentQuestionNo">${sessionScope.currentQuestionNo}</span> of &nbsp; ${totalQuestions} - <span id="questionTopic">${questionAndAnsTestDataVO.topic}</span></b>
					     		</span>
					     		<a href="${pageContext.request.contextPath}/action/leaveTest?testName=${utestName}&techName=${utechName}" >Leave Test</a>
					    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;My Answer:&nbsp;&nbsp;<input type="text" id="showSelectedAnswerId" name="showSelectedAnswerIdAnswer" style="width: 50px;height: 24px;display:inline;!importent" value="" class="form-control" readonly="readonly"/></td>
					     </tr>	
					     ...
					     &nbsp;
					   	   <span id="answerText1Id">${questionAndAnsTestDataVO.answerText1}</span>
					   	    <hr style="color: black;width: 125%;" align="left"/>
					   	   </td>
					   	 </tr>
<!-- 					      <tr align="left"> -->
<!-- 					     	<td  colspan="2" align="left">&nbsp;&nbsp;</td> -->
...
<!-- 					     </tr> -->
					      ...
					      <tr align="left">
					     	...
					     	<td  colspan="1" align="left" id="nextButtonVisible" >
					     	 	<input type="button" value="Next Question" class="mc-btn btn-style-1" id="nextId"/>&nbsp;
					     	 	<input type="button" value="Mark for Review" class="mc-btn btn-style-1" id="markForReview" />
					     	</td>
					     	<td  colspan="2" align="left" id="submitTestButtonVisible">&nbsp;&nbsp;
					     	<input type="button" id="submittest" value="Submit Test" class="mc-btn btn-style-1"/>
					     	</td>
					     </tr>
					      <tr>
           ...
           <!--  <a href="#" class="button"><span><span>Read More</span></span></a> -->
            <div class="pad_left1">
               <br/>	
                 <b style="font-family: 'Lato', sans-serif;font-size: 14px;">About Square Color <img alt="" src="${pageContext.request.contextPath}/images/info.png"></b>
