                ...
                <hr style="color: black"/> 
      			<table border="1" style="width:80%;font-size: 18px; color:black;background-image:url('${pageContext.request.contextPath}/images/bg/page-backgroung.png'); " align="center">
					    ...
					    <%--   <tr height="35px">
					     ...
					     <td>&nbsp;</td>
					   	   <td align="right"> 
					   	   <a href="${pageContext.request.contextPath}/assessment/start-test">
  		...
  		$(function(){
  		   ...
  		   $("input[type='button'][id='updateUsername']").click(function() {
  				var salutation=$("#salutation").val();
		 		  ...
		 		  if(wemail.length==0){
		 			$("#ErrorMessage").html("Email cannot be empty , enter your email please.");
					$("#wemail").focus();
					    return;
				  }
  		 		  
  		 			var contextPath="${pageContext.request.contextPath}";
  					$.ajax({url:contextPath+"/action/update-guest-details", type: 'GET',data:$("#sendLinkModelForm").serialize(),success:function(jsonData) {  //data= this.responseText
    ...
    <div class="modal-content" style="background-image: url('${pageContext.request.contextPath}/images/bg/namebg.jpg');">
      ...
      <div class="form-group">
        ...
        <select type="text" class="form-control" id="salutation" name="salutation" style="width: 50%;">
          ...
          <div class="form-group">
      Enter Name   :   <span style="font-weight: bold;color:red;"></span>
        <input type="text" class="form-control" id="pname" name="name"/>
        </div>
        
         <div class="form-group">
      Enter Email   :   <span style="font-weight: bold;color:red;"></span>
