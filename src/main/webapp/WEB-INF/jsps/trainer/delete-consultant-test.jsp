...
<head>
    ...
    <title>${companyName} - Delete Consultant Test</title>
...
<div id="page-wrap">
  ...
  <section style="padding-top: 0px;padding-bottom:10px;background-color: white;" id="quizz-intro-section">
        ...
        <img src="${pageContext.request.contextPath}/images/icon/bar2.png" style="width: 100%;height: 30px; opacity: 0.90;"/>
                 <h3 style="color: black"><img src="${pageContext.request.contextPath}/images/exam-summary.png" style="height:60px;"/> - <span style="font-family: 'Lato', sans-serif;font-size: 17px;font-weight: bold;">Delete Consultant Test Page</span>
                 </h3>
...
<!-- 						 <b style="color: black">Select Test Name :- </b>  -->
							...
							<div class="col-xs-4">
								<label for="testName" style="font-family: 'Lato', sans-serif;font-size: 14px;">Test Name :</label>
								<select
            ...
            <span style="font-family: 'Lato', sans-serif;font-size: 16px;">Consultant(s) List:-</span>
					    <div style="float: right;">
								<img src="../images/favicon.ico" height="30px">&nbsp;<span style="font-family: 'Lato', sans-serif;font-size: 14px;">Total Users :</span> <b><span id="totalUsers">${fn:length(userList)}</span></b>
							</div>
  ...
  //$('body').prelodr('in', 'Loading data please wait...');
	$.getJSON(ccontextPath+"/action/findUserBygroupNameTestTechNameAjax", {groupName:groupName,testName:testName,techName:techName}, function(jsonResponse) {
    	...
    	tableContent=tableContent+'<th class="author" style="color: white;font-family: \'Lato\', sans-serif;font-size: 14px;">Detail</th>';
      	tableContent=tableContent+'<th class="author" style="color: white;font-family: \'Lato\', sans-serif;font-size: 14px;">Delete Test</th>';
      	...
      	for(var i=0;i<len;i++){
      			val=i+1;
      				...
      				if ("complete".toLowerCase() === jsonResponse[i].techTestStatus.toLowerCase()){
      				...
      				if("Not Started"==jsonResponse[i].techTestStatus){
      					tableContent=tableContent+'<td>'+jsonResponse[i].dot+'</td>';
      				}else{
      					tableContent=tableContent+'<td style="text-align:center;"><img src="${pageContext.request.contextPath}/images/delete-test-icon.png" style="height:24px;"></td>';
      				}
      				tableContent=tableContent+'</tr>'
