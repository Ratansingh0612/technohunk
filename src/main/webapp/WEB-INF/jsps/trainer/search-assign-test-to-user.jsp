...
<div class="body121">
 ...
 <form id="assignTestToUserFrom"
							...
							method="post">	
                <h3 style="color: black"><img src="${pageContext.request.contextPath}/images/icon/search-results.png" width="50px;"/>&nbsp;&nbsp;<b style="font-size: 16px;">Test - > Search & Assign Test To User</b></h3> 
						...
						<label for="searchConsultant" style="font-size: 15px;margin-right: 20px;">Consultant Name/Email</label>		
						 ...
						 <input type="button" value="Search" class="mc-btn btn-style-1"  id="goID" />
						   &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; 
						    <input type="button" value="Clear" class="mc-btn btn-style-1"  id="clearSearch"  onclick="window.location.assign('${pageContext.request.contextPath}/action/search-assign-test-to-user');"/>
						   &nbsp;&nbsp;&nbsp; 
						</div>
							<hr style="border-top: 1px solid #a9a9a9;margin-top: 0px"/>
...
tableContent=tableContent+'</tr>';
			...
			$("#AppMessage").html("Sorry! no record exists for entered name/email.<br/>");		
		}
