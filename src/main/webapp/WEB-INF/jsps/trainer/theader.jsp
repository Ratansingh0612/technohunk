                ...
                <ul class="menu">
                    <li><a href="${pageContext.request.contextPath}/${sessionScope.user_session_data.homePage}">Home</a></li>
                      ...
                      <li class="menu-item-has-children">
                        <a href="#">Attendance</a>
                        <ul class="sub-menu">
                        	<li> <a href="${pageContext.request.contextPath}/action/attendance/consultant-list">Mark Attendance</a></li>
                        	<li> <a href="${pageContext.request.contextPath}/action/show-question-and-answer">View Attendance</a></li>
                        	<li> <a href="${pageContext.request.contextPath}/action/questions-bank"></a></li>
