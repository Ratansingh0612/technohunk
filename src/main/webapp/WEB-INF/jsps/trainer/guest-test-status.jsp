...
<head>
    ...
    <title>${companyName} - Guest Test Status</title>
...
<div id="page-wrap">
  ...
  <section style="padding-top: 0px;padding-bottom:10px;background-color: white;" id="quizz-intro-section" class="quizz-intro-section learn-section">
        <div class="container">
<img src="${pageContext.request.contextPath}/images/icon/Icon_01.png" style="height:40px;"/> - <span style="font-size: 16px;">Report -> Guest Test Status</span>
...
<!-- 						 <b style="color: black">Select Test Name :- </b>  -->
								<div class="col-xs-4">
								<label for="testName" style="font-size: 16px;">Technology :</label>
								<select
							...
							<div class="col-xs-4">
								<label for="testName" style="font-size: 16px;">Test Name :</label>
								<select
            ...
            <img src="${pageContext.request.contextPath}/images/icon/cheers.png" width="30px;"/>
            		<span style="font-family: 'Lato', sans-serif;font-size: 16px;">Guest(s) List:-</span>
				...
				<%-- 	<span style="font-family: 'Lato', sans-serif;font-size: 16px;margin-left: 10px;">
					...
					<img src="${pageContext.request.contextPath}/images/icon/excel.png" style="height: 40px;"/>
					    ...
					    <div style="float: right;">
								...
								<img src="${pageContext.request.contextPath}/images/favicon.ico" height="30px">&nbsp;<span style="font-size: 15px;">Total Users :</span> <b><span id="totalUsers">${fn:length(userList)}</span></b>
							</div>
...
function showGuestTestSummary(email) {
			 $("#semail").val(email);
...
function loadData(){
  ...
  $.getJSON(ccontextPath+"/action/findGuestUserByTestTechNameAjax", {groupName:'guest',testName:'All',techName:'All'}, function(jsonResponse) {
		 //$('body').prelodr('out');
		if(jsonResponse) {
      	...
      	for(var i=0;i<len;i++){
      			val=i+1;
      				...
      				if ("Completed".toLowerCase() === jsonResponse[i].techTestStatus.toLowerCase()){
      					var jsmethod="<a href=javascript:showGuestTestSummary('"+jsonResponse[i].email+"')";
...
$("#selectedGroupName").change(function() {
 ...
 <form method="POST" action="${pageContext.request.contextPath}/action/guest-tech-test-history"  id="guestTestHistoryForm">
			                    <div class="course-keyword">
			                        <input type="hidden" placeholder="Enter your email/consultant id" name="email" id="semail" required="required"/>
			                    </div>
                </form>
</body>
