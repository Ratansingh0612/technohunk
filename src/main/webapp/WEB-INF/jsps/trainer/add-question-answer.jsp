...
$(document).ready(function(){
	...
	$("#nextQuestion").click(function(){
		...
		if(questionText.trim().length==0){
			$("#errorMessage").html("Question Text cannot be blank.");
			$("#questionText").focus();
		...
		if(answerText.trim().length==0){
			$("#errorMessage").html("Answer Text cannot be blank.");
			$("#answerText").focus();
			window.scrollTo(100, 300);
			return;
		}
		$("#addQuestionAnswerForm").submit();
	});
});	
...
<div class="body121">																		
  <div class="main">
   ...
   <!-- END / CONTENT BAR -->
    ...
    <!-- COURSE CONCERN -->
     <form:form id="addQuestionAnswerForm" action="${pageContext.request.contextPath}/action/add-question-answer"  method="POST" commandName="interviewQuestionsAnswerVO"> 
      			 	 ...
      			 	 <tr height="25px" >
					     <td colspan="1" align="left" valign="bottom" >
					           <label for="sel1" style="font-family: 'Lato', sans-serif;font-size: 16px;">Technology:</label>
								 ...
								 &nbsp;&nbsp;
								 <form:select path="topic" items="${topicList}" multiple="false"  class="form-control"  style="width:300px;display:inline;"/>
					     </td>
					   </tr>
					  </tbody>
					 </table>
   <hr style="color: red; width: 100%" />
								<span style="color: red;margin-left: 0px;" align="center" id="errorMessage">${AppMessage}</span>
...
<!-- 								
	&nbsp; -->
					      <input type="button" value="Next Question"
									...
									id="nextQuestion" style="margin-right: -1000px;" />
					      </td>
					     </tr>
						</tbody>     
					</table>  
