   ...
   <!-- END / CONTENT BAR -->
    ...
    <section class="quizz-intro-section" style="padding-top: 0px;padding-bottom:10px;background-color: #eee;" id="content">
        ...
        <div class="container" style="background-color: white;min-height: 600px;">
                <h3 style="color: black"><img src="${pageContext.request.contextPath}/images/icon/search-results.png" width="50px;"/>&nbsp;&nbsp;<b style="font-size: 16px;">Test - > Search Guest Test History</b></h3> 
