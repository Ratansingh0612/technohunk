...
<div id="page-wrap">
  ...
  <div class="main">
   ...
   <!-- END / CONTENT BAR -->
    ...
    <!-- COURSE CONCERN -->
  <section style="padding-top: 0px;min-height:600px;background-color:#eee " id="quizz-intro-section">
  		<br/>
        <div class="container" style="background-color: white;">
            <div class="title-ct">
             <h3 style="color: black;margin-top: -5px;"><img src="${pageContext.request.contextPath}/images/icon/Icon_01.png" width="40px;"/> - <span style="font-size: 16px;">Test - > Consultant Test History Details</span></h3>
             		<br/>
                  <h3 style="font-size: 16px;margin-top: 0px;display: inline;margin-right: 20px;"> Group/Batch :</h3>
             ...
             <form:form id="userTestHistoryForm"
							...
							<hr style="color: blue;" /><hr style="color: blue;" />
...
function loadData(){
  ...
  //$('body').prelodr('in', 'Loading data please wait...');
	$.getJSON(ccontextPath+"/action/findConsultantsByBatch", {batchName:groupName}, function(jsonResponse) {
    	...
    	tableContent=tableContent+'<th class="author" style="color: white;font-family: \'Lato\', sans-serif;font-size: 14px;">Test Detail</th>';
      	...
      	for(var i=0;i<len;i++){
      			val=i+1;
      				...
      				var jsmethod="<a href=\"javascript:showUserHistory('"+jsonResponse[i].userid+"');\"";
