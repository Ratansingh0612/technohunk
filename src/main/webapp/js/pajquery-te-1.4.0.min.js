	...
	e.fn.pajqte = function(t) {
		...
		return this
				.each(function() {
					...
					if (!e(this).data("pajqte") || e(this).data("pajqte") == null
							|| e(this).data("pajqte") == "undefined")
						e(this).data("pajqte", true);
					else
						e(this).data("pajqte", false);
					if (!u.status || !e(this).data("pajqte")) {
						if (e(this).closest("." + u.css).length > 0) {
							...
							var o = e(this).clone();
							e(this).data("pajqte", false).closest("." + u.css)
									.before(o).remove();
