    ...
    $.fn.timeDropper = function(options, callbackFnk) {
        return $(this).each(function() {
            ...
            _td_overlay.click(function() {
                ...
                var shrs=starttimeTokens[0];
                var ehrs=endtimeTokens[0];
                
                var smnts=starttimeTokens[1];
                var emnts=endtimeTokens[1];
                var tsmins= parseInt(shrs*60)+parseInt(smnts);   
                var temins= parseInt(ehrs*60)+parseInt(emnts);   
                var difference=temins-tsmins;
                $("#timeduration").val(difference);
                // alert("starttime = "+starttime+" & end time = "+endtime+" difference = "+difference);
