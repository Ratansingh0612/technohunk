 <header id="header" class="header">
        <div class="container">
            <div class="logo"><a href="${pageContext.request.contextPath}/action/thome"><img src="${pageContext.request.contextPath}/images/logo.png" alt="" style="margin-top: 25px;"></a>
            </div>
            <!-- END / LOGO -->
			<br/><br/>
            <!-- NAVIGATION -->
            <nav class="navigation">
                ...
                <!-- MENU -->
                <ul class="menu">
                    <li class="current-menu-item"><a href="${pageContext.request.contextPath}/action/thome">Home</a></li>
                   <!--  <li class="menu-item-has-children megamenu col-4">
                    ...
                    <li class="menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="${pageContext.request.contextPath}/action/consultant/registration">Register</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/action/java-full-stack-developer">Course</a>
                    </li>
                </ul>
                <!-- END / MENU -->
                        ...
                        <div class="toggle-message toggle-list">
                            ...
                            <ul class="list-message">
                                ...
                                <li class="ac-new">
                                    <a href="#">
                                        <div class="image">
                                            <img src="${pageContext.request.contextPath}/images/test-icon.png" alt="">
                                        </div>
                                        <div class="list-body">
                                            <div class="author">
                                                <span>Ameya</span>
                                ...
                                <li>
                                    <a href="#">
                                        ...
                                        <div class="list-body">
                                            ...
                                            <p>We are waiting for new test</p>
                                            <div class="time">
                                ...
                                <li class="ac-new">
                                    <a href="#">
                                        <div class="list-body">
                                            ...
                                            <div class="image">
                                                <img src="${pageContext.request.contextPath}/images/feature/node-icon.png" alt="" style="height: 50px;width: 100%;">
                                            </div>
                                            <div class="time">
                                    ...
                                    <a href="#">
                                        <div class="list-body">
                                            <div class="author">
                                                ...
                                                <p>online test is starting soon.</p>
                                            <div class="image">
                                                <img src="${pageContext.request.contextPath}/images/feature/cplus.png" alt="" style="height: 50px;width: 50px;">
                                            </div>
                                            <div class="time">
                                                <span>5 minutes ago</span>
                                            </div>
                                    ...
                                    <a href="#">
                                        <div class="list-body">
                                            <div class="author">
                                               ...
                                               <p>online test is starting soon.</p>
                                            <div class="image">
                                                  <img src="${pageContext.request.contextPath}/images/feature/python.png" alt="" style="height: 50px;width: 50px;">
                                            </div>
                                            <div class="time">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="list-body">
                                            ...
                                            <p>online test is starting soon.</p>
                                            <div class="image">
                                                <img src="${pageContext.request.contextPath}/images/feature/angular2.png" alt="" style="height: 50px;width: 50px;">
                                            </div>
                                            <div class="time">
                                                <span>120 minutes ago</span>
                                            </div>
                                        </div>
                                    </a>
                                </li>
                                    ...
                                    <a href="#">
                                        <div class="list-body">
                                            <div class="author">
                                              ...
                                              <p>online test is starting soon.</p>
                                            <div class="image">
                                                        <img src="${pageContext.request.contextPath}/images/feature/core-java.jpg" alt="">
                                            </div>
                                            <div class="time">
                                                <span>210 minutes ago</span>
                                            </div>
                                        </div>
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="list-body">
                                            ...
                                            <p>online test is starting soon.</p>
                                            <div class="image">
                                                <img src="${pageContext.request.contextPath}/images/feature/react-js.png" alt="" style="height: 50px;width: 100%;">
                                            </div>
                                            <div class="time">
                                                <span>290 minutes ago</span>
                                            </div>
                                        </div>
                                    </a>
                                </li>
                                    ...
                                    <a href="#">
                                        <div class="list-body">
                                            <div class="author">
                                             ...
                                             <p>online test is starting soon.</p>
                                            <div class="image">
                                                <img src="${pageContext.request.contextPath}/images/feature/ds.png" alt="" style="height: 50px;width: 100%;">
                                            </div>
                                            <div class="time">
                                                <span>350 minutes ago</span>
                                            </div>
                                        </div>
                                    </a>
                                </li>
