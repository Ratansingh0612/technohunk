 <header id="header" class="header">
        <div class="container">
            <!-- LOGO -->
            <div class="logo"><a href="${pageContext.request.contextPath}/home/jsp" style="display: inline;"><img src="${pageContext.request.contextPath}/images/logo.png" alt="" style="margin-top: 25px;"></a>
            ...
            <nav class="navigation">
                ...
                <!-- MENU -->
                <ul class="menu">
                    <li><a href="${pageContext.request.contextPath}/action/thome">Home</a></li>
